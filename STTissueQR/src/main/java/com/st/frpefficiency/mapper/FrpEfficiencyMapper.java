 ...
 *
 */
public class FrpEfficiencyMapper implements RowMapper<FrpEfficiency> {

	
	@Override
	public FrpEfficiency mapRow(ResultSet rs, int arg1) throws SQLException {
		...
		efficency.setBatchNo(rs.getString(Columns.COL_07));
		efficency.setGrade(rs.getString(Columns.COL_08));
