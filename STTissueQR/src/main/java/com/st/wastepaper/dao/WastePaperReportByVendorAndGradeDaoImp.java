/**
 *Aug 14, 2015
 *WastePaperReportByVendorAndGradeDaoImp.java
 * TODO
 ...
 */
@Repository
public class WastePaperReportByVendorAndGradeDaoImp implements WastePaperReportByVendorAndGradeDao{
	...
	/* (non-Javadoc)
	 * @see com.st.wastepaper.dao.WastePaperReportByVendorAndGradeDao#load(java.util.Date, java.util.Date, int, java.lang.String)
	 */
	@Override
	public List<WastepaperDetail> load(Date sDate, Date eDate, int gradeid,String vendorname) {
...
//				Code Ends Here Done By Roshan Tailor Date :- 06/04/2015 MM/DD/YYY Night Shift
				...
				int gradeName=wastepaperDetail.getGradeid();
				String vendorName=wastepaperDetail.getVandorName();
				if(gradeid==gradeName && vendorname.equalsIgnoreCase(vendorName)){
