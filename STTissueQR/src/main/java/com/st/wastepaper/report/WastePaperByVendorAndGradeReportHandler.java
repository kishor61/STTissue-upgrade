/**
 *Aug 17, 2015
 *WastePaperByVendorAndGradeReportHandler.java
 * TODO
 ...
 */
@Component
public class WastePaperByVendorAndGradeReportHandler {
	...
	public void getByVendorAndGradeReport(List<WastepaperDetail> details,
		...
		for(WastepaperDetail gnvDetail:details){
			col=0;
			if(gnvDetail.getDroppedDate()==null ||gnvDetail.getUnloadedDate()==null){
				
			}else{
				util.addValue(row, col++, "", Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getMasterPO(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getReleaseNo(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getVandorName(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				
				util.addValue(row, col++, dateFormat.format(gnvDetail.getDroppedDate()), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, dateFormat.format(gnvDetail.getUnloadedDate()), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getItemDescription(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getBales(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getNetTons(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getPricePerTon(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getExtention(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getCarrier(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getTrailerNo(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getShippingCity(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getShippingState(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getEstimatedFreight(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getFreightInvoiced(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getFreightCHBK(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getGrandTotal(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getDestination(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				util.addValue(row, col++, gnvDetail.getComment(), Workbook2007Util.Style.STYLE_NORMAL_CENTER, rowHeight);
				row++;
			}
