 ...
 */
@Controller
@RequestMapping(value="/centerlinereport")
public class CenterlineReportController {
	...
	public String viewDataCenterlineData2(@RequestParam("sdate")String sdate,
		...
		if(grade!=0){
			...
			return "centerlineView2_AllToShow";
		}
	...
	private HSSFWorkbook getFormatedWorkbook(File file,
		...
		//objectFont.setBoldweight(Font.BOLDWEIGHT_BOLD);
		objectFont.setBold(true);  // Set font to bold
