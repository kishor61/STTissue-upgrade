 ...
 */
@Component
public class EfficiencyReportByDCSHandler {
	 ...
	 */
	public void getByEfficiencyDCSReportExport(List<EfficiencyShiftData> datas,
			List<EfficiencyShiftData> datas1, File file,
		...
		for (EfficiencyShiftData data : datas) {
			...
			<tr>
				...
				*/
				...
				for(EfficiencyShiftData data1:datas1){
