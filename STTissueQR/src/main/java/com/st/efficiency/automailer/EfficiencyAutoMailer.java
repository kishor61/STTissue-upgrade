 ...
 *Sunil Singh Bora
 */
package com.st.efficiency.automailer;
 ...
 */
@Component
public class EfficiencyAutoMailer {
	private static final Logger logger=LoggerFactory.getLogger(EfficiencyAutoMailer.class);
