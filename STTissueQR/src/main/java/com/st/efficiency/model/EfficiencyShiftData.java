 ...
 *
 */
public class EfficiencyShiftData {
	private Date date;
	 ...
	 * 
	 */
	public EfficiencyShiftData() {}
	
	public EfficiencyShiftData(Date date,String shift) {this.date=date;this.shift=shift;}
	...
	public boolean equals(Object obj) {
		EfficiencyShiftData data=(EfficiencyShiftData)obj;
...
//Code Starts From Here Done By Roshan Tailor
	public EfficiencyShiftData totalA(List<EfficiencyShiftData> data){
		...
		int sizeA=0;
		for (EfficiencyShiftData efficiencyShiftDataA : data) {
	...
	public EfficiencyShiftData totalB(List<EfficiencyShiftData> data){
		EfficiencyShiftData shiftData=new EfficiencyShiftData();
		double toatlEff=0;
		for (EfficiencyShiftData efficiencyShiftData : data) {
			if(efficiencyShiftData.getCrew().equalsIgnoreCase("B")){
				...
				int sizeB=0;
				for (EfficiencyShiftData efficiencyShiftDataB : data) {
	...
	public EfficiencyShiftData totalC(List<EfficiencyShiftData> data){
		EfficiencyShiftData shiftData=new EfficiencyShiftData();
		double toatlEff=0;
		for (EfficiencyShiftData efficiencyShiftData : data) {
		...
		int sizeC=0;
		for (EfficiencyShiftData efficiencyShiftDataC : data) {
	...
	public EfficiencyShiftData totalD(List<EfficiencyShiftData> data){
		EfficiencyShiftData shiftData=new EfficiencyShiftData();
		double toatlEff=0;
		for (EfficiencyShiftData efficiencyShiftData : data) {
			...
			//Final Efficiency Avg. Grant For D Shift
				int sizeD=0;
				for (EfficiencyShiftData efficiencyShiftDataD : data) {
...
//Code Ends Here Done By Roshan Tailor
	...
	public EfficiencyShiftData total(List<EfficiencyShiftData> data){
		EfficiencyShiftData shiftData=new EfficiencyShiftData();
		double toatlEff=0;
		for (EfficiencyShiftData efficiencyShiftData : data) {
			shiftData.setActualWt(CommonUtil.round(shiftData.getActualWt()+efficiencyShiftData.getActualWt(), 2));
