 ...
 *
 */
public interface ConvertingLineDao {
	 ...
	 * @return
	 */
	List<ConvertingLine> getForeCastDataGroupBySKUCode(Date date1, Date date2,
			String skucode);
	 ...
	 * @return
	 */
	List getOperatorDataListRewind(String startDate, String endDate, String string);
