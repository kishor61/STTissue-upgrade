 ...
 */
@Controller
@RequestMapping(value = "/frpproductionreport")
public class FrpProdcutionReportController {
	...
	@Autowired
	private FrpProdcutionReportAutoMailer frpprodcutionreportautoMailer;
	...
	public String viewData(HttpServletRequest request, Model model) {
		...
		try {
			...
			List<FrpProdcution> frpProdcutions = frpProdcutionService.getFrpProdcutions(dateFormat1.parse(sdate),
					dateFormat1.parse(edate), prodType, grade);

			System.out.println("frpProdcutions::" + frpProdcutions.size());
			System.out.println(frpProdcutions);
			// Code Starts From Here Done By Roshan Tailor Date :- 04/26/2016
			List<WastePaperBaleInventory> consumedBalesData = wastePaperUnloadBaleInventoryService
					.getConsumedData(dateFormat1.parse(sdate), dateFormat1.parse(edate));
			System.out.println("consumedBalesData::" + consumedBalesData.size());
			// Code Ends Here Done By Roshan Tailor Date:- 04/26/2016
	...
	public void export(HttpServletRequest request, HttpServletResponse response, Model model) {
		 ...
		 * model.addAttribute("prodType", prodType); model.addAttribute("viewFlag",
		 * true);
		 */
		...
		response.setHeader("Content-Disposition", "attachment; filename=FrpProduction Report.xls");
	...
	private HSSFWorkbook getFormatedWorkbook(File file, Map<String, Object> datas, String prodType) throws IOException {
	...
	private Map<String, Object> formatData(List<FrpProdcution> frpProdcutions,
		...
		List<Double> serweFlow = new ArrayList<>();
		...
		for (FrpProdcution frpProdcution : frpProdcutions) {
			...
			totalProdADSTs.add(CommonUtil.round(
					CommonUtil.round(frpProdcution.getCol6(), 2) + CommonUtil.round(frpProdcution.getCol7(), 2), 2));

			// trackerWPfeeds.add(frpProdcution.getTrackerWPfeed()); // Commented By Roshan
			// These Values Now Are Coming From Tracker So Use Them In Below Loop

			// yieldDcss.add(frpProdcution.getYieldDcs());
			yieldDcss.add(CommonUtil.round(
					((CommonUtil.round(frpProdcution.getCol6(), 2) + CommonUtil.round(frpProdcution.getCol7(), 2))
							/ (CommonUtil.round(frpProdcution.getCol9(), 2))) * 100,
					2));
			...
			/*
			 * Commented By Roshan These Values Now Are Coming From Tracker So Use Them In
			 * Below Loop mrMwlAndSwls.add(frpProdcution.getMrMwlAndSwl());
			 * mrSowAndCbss.add(frpProdcution.getMrSowAndCbs());
			 * mrDlks.add(frpProdcution.getMrDlk()); mrOccs.add(frpProdcution.getMrOcc());
		...
		for (WastePaperBaleInventory consumedBales : consumedBalesData) {
			...
			wpmSowAndCbss.add(CommonUtil
					.round(consumedBales.getTotalbalesweightForSOW() + consumedBales.getTotalbalesweightForCBS(), 2));
			...
			wpmNewsNewsblanks.add(CommonUtil.round(consumedBales.getTotalbalesweightForNewsblank()
					+ consumedBales.getTotalbalesweightForONPOldNewsPrint(), 2));
			...
			wpmOthers.add(CommonUtil.round(
					consumedBales.getTotalbalesweightForOtherRolls() + consumedBales.getTotalbalesweightForMixedPaper()
							+ consumedBales.getTotalbalesweightForHoggedBooks()
							+ consumedBales.getTotalbalesweightForBrownNapkinBroke(),
					2));

			wpmTotals.add(CommonUtil.round(consumedBales.getTotalbalesweightForMWL()
					+ consumedBales.getTotalbalesweightForPrtmix() + consumedBales.getTotalbalesweightForCBS()
					+ consumedBales.getTotalbalesweightForSOW() + consumedBales.getTotalbalesweightForSWL()
					+ consumedBales.getTotalbalesweightForCtdGdwd() + consumedBales.getTotalbalesweightForOCC()
					+ consumedBales.getTotalbalesweightForNewsblank()
					+ consumedBales.getTotalbalesweightForONPOldNewsPrint() + consumedBales.getTotalbalesweightForDLK()
					+ consumedBales.getTotalbalesweightForMailUndeliverable()
					+ consumedBales.getTotalbalesweightForOtherRolls()
					+ consumedBales.getTotalbalesweightForMixedPaper()
					+ consumedBales.getTotalbalesweightForHoggedBooks()
					+ consumedBales.getTotalbalesweightForBrownNapkinBroke(), 2));
			...
			mrMwlAndSwls.add(CommonUtil.round((CommonUtil.round(consumedBales.getTotalbalesweightForMWL(), 2)
					...
					/ CommonUtil.round(consumedBales.getTotalbalesweightForMWL()
							+ consumedBales.getTotalbalesweightForPrtmix() + consumedBales.getTotalbalesweightForCBS()
							+ consumedBales.getTotalbalesweightForSOW() + consumedBales.getTotalbalesweightForSWL()
							+ consumedBales.getTotalbalesweightForCtdGdwd() + consumedBales.getTotalbalesweightForOCC()
							+ consumedBales.getTotalbalesweightForNewsblank()
							+ consumedBales.getTotalbalesweightForONPOldNewsPrint()
							+ consumedBales.getTotalbalesweightForDLK()
							+ consumedBales.getTotalbalesweightForMailUndeliverable()
							+ consumedBales.getTotalbalesweightForOtherRolls()
							+ consumedBales.getTotalbalesweightForMixedPaper()
							+ consumedBales.getTotalbalesweightForHoggedBooks()
			...
			mrDlks.add(CommonUtil.round(CommonUtil.round(consumedBales.getTotalbalesweightForDLK(), 2)
					/ CommonUtil.round(consumedBales.getTotalbalesweightForMWL()
							+ consumedBales.getTotalbalesweightForPrtmix() + consumedBales.getTotalbalesweightForCBS()
							+ consumedBales.getTotalbalesweightForSOW() + consumedBales.getTotalbalesweightForSWL()
							+ consumedBales.getTotalbalesweightForCtdGdwd() + consumedBales.getTotalbalesweightForOCC()
			...
			mrOccs.add(CommonUtil.round(CommonUtil.round(consumedBales.getTotalbalesweightForOCC(), 2)
					/ CommonUtil.round(consumedBales.getTotalbalesweightForMWL()
							+ consumedBales.getTotalbalesweightForPrtmix() + consumedBales.getTotalbalesweightForCBS()
							+ consumedBales.getTotalbalesweightForSOW() + consumedBales.getTotalbalesweightForSWL()
							+ consumedBales.getTotalbalesweightForCtdGdwd() + consumedBales.getTotalbalesweightForOCC()
			...
			// mrWhiteGradess.add(frpProdcution.getMrWhiteGrades());
			// var
			// mrWhiteGradesNum=((wpmMwlNum+wpmPrintMixNum+wpmSwlNum+wpmSowAndCbsNum)/wpmTotalNum)*100;
			mrWhiteGradess.add(CommonUtil.round((CommonUtil.round(consumedBales.getTotalbalesweightForMWL(), 2)
					...
					+ CommonUtil.round(consumedBales.getTotalbalesweightForSWL(), 2)
					+ CommonUtil.round(
							consumedBales.getTotalbalesweightForSOW() + consumedBales.getTotalbalesweightForCBS(), 2))
					/ CommonUtil.round(consumedBales.getTotalbalesweightForMWL()
							+ consumedBales.getTotalbalesweightForPrtmix() + consumedBales.getTotalbalesweightForCBS()
							+ consumedBales.getTotalbalesweightForSOW() + consumedBales.getTotalbalesweightForSWL()
							+ consumedBales.getTotalbalesweightForCtdGdwd() + consumedBales.getTotalbalesweightForOCC()
					...
					2));
			// mrGroundwoods.add(frpProdcution.getMrGroundwood());
			mrGroundwoods.add(CommonUtil.round((CommonUtil
					.round(consumedBales.getTotalbalesweightForNewsblank()
							+ consumedBales.getTotalbalesweightForONPOldNewsPrint(), 2)
					+ CommonUtil.round(consumedBales.getTotalbalesweightForCtdGdwd(), 2))
					/ CommonUtil.round(consumedBales.getTotalbalesweightForMWL()
							+ consumedBales.getTotalbalesweightForPrtmix() + consumedBales.getTotalbalesweightForCBS()
			...
			mrOthers.add(CommonUtil.round(CommonUtil
					.round(consumedBales.getTotalbalesweightForOtherRolls()
							+ consumedBales.getTotalbalesweightForMixedPaper()
							+ consumedBales.getTotalbalesweightForHoggedBooks()
							+ consumedBales.getTotalbalesweightForBrownNapkinBroke(), 2)
					/ CommonUtil.round(consumedBales.getTotalbalesweightForMWL()
			...
			double i = CommonUtil.round(consumedBales.getTotalbalesweight(), 2);
		...
		for (int i = 0; i < frpProdcutions.size(); i++) {
			...
			double totalProdADST = CommonUtil.round(frpProdcution.getCol6(), 2)
					+ CommonUtil.round(frpProdcution.getCol7(), 2);
			// int trackerWPFeed=consumedBales.getTotalbales();
			double trackerWPFeed = CommonUtil.round(consumedBales.getTotalbalesweight(), 2);
		...
		if (ids.size() > 0) {
			...
			System.out.println("trackerWPfeeds::" + trackerWPfeeds);
			...
			if (prodType.equalsIgnoreCase("BW")) {
				datas.put(Rows.ROW_39, CommonUtil.round(sumMTDMwlAndSwl, 2));
			} else {
				datas.put(Rows.ROW_39, 0);
			}

			double sumMTDSow = ((sumWpmPrintMixs + sumWpmCbss + sumWpmCtdGrwds + sumWpmSows) / sumWpmTotals) * 100;
			if (prodType.equalsIgnoreCase("BW")) {
			...
			double sumMTDWhiteGrades = ((sumWpmMwls + sumWpmPrintMixs + sumWpmSwls + sumWpmSowAndCbss) / sumWpmTotals)
					* 100;
			...
			double sumMTDGroundwood = ((sumWpmNewsNewsblanks + sumWpmCtdGrwds) / sumWpmTotals) * 100;
			if (prodType.equalsIgnoreCase("KF")) {
				datas.put(Rows.ROW_42, CommonUtil.round(sumMTDGroundwood, 2));
			} else {
				datas.put(Rows.ROW_42, 0);
			}
	...
	@RequestMapping(value = "/view/data/sendmail", method = RequestMethod.POST)
	public @ResponseBody boolean email(HttpServletRequest request, HttpServletResponse response, Model model)
		...
		try {
			/*
			 * List<FrpProdcution>
			 * frpProdcutions=frpProdcutionService.getFrpProdcutions(dateFormat1.parse(sdate
			 * ), dateFormat1.parse(edate), prodType,grade); List<WastePaperBaleInventory>
			 * consumedBalesData=wastePaperUnloadBaleInventoryService.getConsumedData(
			 * dateFormat1.parse(sdate), dateFormat1.parse(edate));
			 * datas=formatData(frpProdcutions,consumedBalesData,prodType);
			 */

			frpprodcutionreportautoMailer.sendMailAt8am(sdate, edate, prodType, grade);
	...
	// Code Endfs Here Done By Roshan Tailor
}
