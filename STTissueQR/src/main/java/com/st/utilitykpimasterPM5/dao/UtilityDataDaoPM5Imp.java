 ...
 */
@Repository
public class UtilityDataDaoPM5Imp implements UtilityDataPM5Dao {
	...
	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.dao.UtilityDataPM5Dao#getPrevUtilityData(int)
	 */
	@Override
	public UtilityData getPrevUtilityData(int id) {
		JdbcTemplate jdbcTemplate=new JdbcTemplate(dataSource);
		
		String sql1="select * from [utilityData_PM5] where [ID]=?";
		
		UtilityData utilityData=jdbcTemplate.queryForObject(sql1, new Object[]{id},new UtilityDataMapper());
		
		String sql2="select TOP 1 * from [utilityData_PM5] where "
				+ "[Date]<("
				+ "select [Date] from [utilityData_PM5] where [ID]=?"
				+ ") order by [Date] desc";
		...
		if(prevUtilityData!=null){
			...
			if(days==1){
				...
				final String sql="update [utilityData_PM5] set "
						+"[Consumption1]=?,"
						+"[Consumption2]=?,"
						+"[Consumption3]=?,"
						+"[Consumption4]=?,"
	...
	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.dao.UtilityDataPM5Dao#save(com.st.utilitykpimaster.model.UtilityData)
	 */
	@Override
	public int save(final UtilityData utilityData) {
		...
		final String sql="insert into [utilityData_PM5]"
				+ "("
				+"[Date],"
				+"[Lb60],"
				+"[Consumption1],"
	...
	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.dao.UtilityDataPM5Dao#update(com.st.utilitykpimaster.model.UtilityData)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.dao.UtilityDataPM5Dao#delete(int)
	 */
	@Override
	public void delete(int id) {
		...
		String sql="delete from [utilityData_PM5] where [ID]=?";
	...
	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.dao.UtilityDataPM5Dao#getUtilityDatasL31()
	 */
	@Override
	public List<UtilityData> getUtilityDatasL31() {
		JdbcTemplate jdbcTemplate=new JdbcTemplate(dataSource);
		
		String sql="select TOP 1 * from [utilityData_PM5] order by [Date] desc";
	...
	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.dao.UtilityDataPM5Dao#getPrevUtilityData(java.util.Date, java.util.Date)
	 */
	@Override
	public List<UtilityData> getPrevUtilityData(Date sdate, Date edate) {
		...
		String sql="select * from [utilityData_PM5]"
	...
	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.dao.UtilityDataPM5Dao#getUtilityData(int)
	 */
	@Override
	public UtilityData getUtilityData(int id) {
		JdbcTemplate jdbcTemplate=new JdbcTemplate(dataSource);
		
		String sql="select * from [utilityData_PM5] where [ID]=?";
