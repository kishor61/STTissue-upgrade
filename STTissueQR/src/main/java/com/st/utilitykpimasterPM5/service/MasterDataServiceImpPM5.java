 ...
 */
@Service
public class MasterDataServiceImpPM5 implements MasterDataServicePM5{

	private SimpleDateFormat dateFormat=new SimpleDateFormat("MM-dd-yyyy");
	private SimpleDateFormat timeFormat=new SimpleDateFormat("HH:mm");
	
	@Autowired
	private MasterDataDaoPM5 masterDataDaoPM5;
	...
	@Autowired
	private MachineProductionDaoPM5 machineProductionPM5Dao;
	...
	@Autowired
	private EfficiencyDaoPM5 efficiencyPM5Dao;
	
	@Autowired
	private FrpProdcutionDao frpProdcutionDao;
	
	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.controller.MasterDataServicePM5#getMasterDatasL31()
	 */
	@Override
	public List<MasterData> getMasterDatasL31() {
		// TODO Auto-generated method stub
		return masterDataDaoPM5.getMasterDatasL31();
	}

	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.controller.MasterDataServicePM5#getMasterData(int)
	 */
	@Override
	public MasterData getMasterData(int id) {
		// TODO Auto-generated method stub
		return masterDataDaoPM5.getMasterData(id);
	}

	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.controller.MasterDataServicePM5#save(com.st.utilitykpimaster.model.MasterData)
	 */
	@Override
	@Transactional
	public int save(MasterData masterData) {
		// TODO Auto-generated method stub
		return masterDataDaoPM5.save(masterData);
	}

	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.controller.MasterDataServicePM5#update(com.st.utilitykpimaster.model.MasterData)
	 */
	@Override
	@Transactional
	public void update(MasterData masterData) {
		// TODO Auto-generated method stub
		masterDataDaoPM5.update(masterData);
	}

	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.controller.MasterDataServicePM5#delete(int)
	 */
	@Override
	@Transactional
	public void delete(int id) {
		// TODO Auto-generated method stub
		masterDataDaoPM5.delete(id);
	}

	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.controller.MasterDataServicePM5#getMasterDatas(java.util.Date, java.util.Date)
	 */
	@Override
	public List<MasterData> getMasterDatas(Date sdate, Date edate) {
		// TODO Auto-generated method stub
		return masterDataDaoPM5.getMasterDatas(sdate,edate);
	}

	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.controller.MasterDataServicePM5#getReportData(java.lang.Object, java.lang.String)
	 */
	@Override
	public List<Map<String, String>> getReportData(Object data, String type)
		...
		if(type.equalsIgnoreCase("U")){
			...
			//	System.out.println("Date"+masterData.getDate());
				...
				List<UtilityData> utilityDatas=utilityDataPM5Dao.getPrevUtilityData(masterData.getDate(), masterData.getDate());
				...
				List<MachineProductionPM5> machineProductions=machineProductionPM5Dao.getMachineProductions(scal.getTime(),ecal.getTime());
				...
				List<WrapperProductionPM5> wrapperProductions=wrapperProductionPM5Dao.getWrapperProductions(scal.getTime(),ecal.getTime());
			...
			//	System.out.println("End Date="+efficiency.getEndDate());
				...
				List<EfficiencyPM5> efficiencies=efficiencyPM5Dao.getEfficiencies(efficiency);
	...
	/* (non-Javadoc)
	 * @see com.st.utilitykpimasterPM5.service.MasterDataServicePM5#getMasterDatasBetweenDates(java.util.Date, java.util.Date)
	 */
	@Override
	@Transactional
	public List<MasterData> getMasterDatasBetweenDates(Date sdate, Date edate) {
		// TODO Auto-generated method stub
		return masterDataDaoPM5.getMasterDatasBetweenDates(sdate,edate);
	}
