/**
 *May 1, 2017
 *CLRewinderReportHandller.java
 * TODO
 *com.st.clrewinder.reporthandler
 *CLRewinderReportHandller.java
 *Roshan Lal Tailor
 */
package com.st.clrewinder.reporthandler;
 ...
 */
@Component
public class CLRewinderReportHandller {
	...
	public void winderbreakmonitoringreportExport(
			List<CLRewinder> winderMonitoringData, File file,
		...
		int row=3;
		int col=0;
		for(CLRewinder wmd:winderMonitoringData)
		{
			col=0;
