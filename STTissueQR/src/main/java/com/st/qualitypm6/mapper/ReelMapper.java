...
public class ReelMapper implements RowMapper<Reel> {

	@Override
	public Reel mapRow(ResultSet rs, int arg1) throws SQLException {
		Reel reel=new Reel();
...
//		Code Ends Here Done By Roshan Tailor 
		...
		reel.setCustomer1(rs.getString(Columns.COL_32));
		reel.setCustomer2(rs.getString(Columns.COL_33));
