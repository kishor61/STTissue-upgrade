...
import com.st.frpprojectionJon.dao.FrpProjectionJonDao;
 ...
 */
@Service
public class FrpProjectionJonServiceImp implements FrpProjectionJonService {

	@Autowired
	private FrpProjectionJonDao frpProjectionDao;
	...
	public FrpProjectionData getFrpProjectionData(Date sdate, Date edate,
		...
		if(temp.equalsIgnoreCase("N")){
			projectionDatas=frpProjectionDao.getProjectionData(sdate,edate,gradeIds);
