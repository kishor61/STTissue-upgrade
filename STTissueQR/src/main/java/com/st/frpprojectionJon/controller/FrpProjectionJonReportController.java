 ...
 */
@Controller
@RequestMapping(value="/frpprojectionreportjon")
public class FrpProjectionJonReportController {
	...
	public String view(HttpServletRequest request,Model model) {
		...
		CommonUtil.save(CommonUtil.FRP_PROJECTION_PAGE, request.getRequestURI());
		System.out.println(CommonUtil.FRP_PROJECTION_PAGE+" ----"+request.getRequestURI());
		model.addAttribute(CommonUtil.FRP_PROJECTION_PAGE, request.getRequestURI());
		...
		model.addAttribute("jonFlag", false);
		model.addAttribute("showFlag", false);
		
		return "frp/projectionView";
	}
	@RequestMapping(value="/view/john" ,method=RequestMethod.GET)
	public String viewJohn(HttpServletRequest request,Model model) {
		
		CommonUtil.save(CommonUtil.FRP_PROJECTION_JON_PAGE, request.getRequestURI());
		System.out.println(CommonUtil.FRP_PROJECTION_JON_PAGE+" ----"+request.getRequestURI());
		model.addAttribute(CommonUtil.FRP_PROJECTION_JON_PAGE, request.getRequestURI());
		
		model.addAttribute("frpgrade", FrpCommon.getGrade());
		model.addAttribute("sdate", dateFormat.format(new Date()));
		model.addAttribute("edate", dateFormat.format(new Date()));
		model.addAttribute("Flag", false);
		model.addAttribute("jonFlag", true);
		model.addAttribute("showFlag", false);
		
		return "frp/projectionViewJoan";
	}
	...
	public String viewData(HttpServletRequest request,Model model) {
		...
		CommonUtil.save(CommonUtil.FRP_PROJECTION_PAGE, request.getRequestURI()+"?"+request.getQueryString());
		model.addAttribute(CommonUtil.FRP_PROJECTION_PAGE, request.getRequestURI()+"?"+request.getQueryString());
		...
		FrpProjectionData projectionData=frpProjectionService.getFrpProjectionData(sdate,edate,productIds,temp);
	...
	@RequestMapping(value="/view/data/john",method=RequestMethod.GET)
	public String viewData_jon(HttpServletRequest request,Model model) {
		
		
		CommonUtil.save(CommonUtil.FRP_PROJECTION_JON_PAGE, request.getRequestURI()+"?"+request.getQueryString());
		model.addAttribute(CommonUtil.FRP_PROJECTION_JON_PAGE, request.getRequestURI()+"?"+request.getQueryString());
