 ...
 *
 */
public class CenterlineGradePM5Mapper  implements RowMapper<CenterlineGrade> {
	...
	public CenterlineGrade mapRow(ResultSet rs, int arg1) throws SQLException {
		...
		//More New Fields
		/*centerline.setBasisweighttargetMinC(rs.getDouble("basisweighttargetMinC"));
		centerline.setBasisweighttarget(rs.getDouble("basisweighttarget"));
		centerline.setBasisweighttargetMaxC(rs.getDouble("basisweighttargetMaxC"));*/
		
		centerline.setMoisturetargetMinC(rs.getDouble("moisturetargetMinC"));
		centerline.setMoisturetarget(rs.getDouble("moisturetarget"));
		centerline.setMoisturetargetMaxC(rs.getDouble("moisturetargetMaxC"));
		
		
		centerline.setYankeemapflowMinC(rs.getDouble("yankeemapflowMinC"));
		centerline.setYankeemapflow(rs.getDouble("yankeemapflow"));
		centerline.setYankeemapflowMaxC(rs.getDouble("yankeemapflowMaxC"));
		

		centerline.setMachinechestpumpspeedMinC(rs.getDouble("machinechestpumpspeedMinC"));
		centerline.setMachinechestpumpspeed(rs.getDouble("machinechestpumpspeed"));
		centerline.setMachinechestpumpspeedMaxC(rs.getDouble("machinechestpumpspeedMaxC"));
