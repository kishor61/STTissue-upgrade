 ...
 */
@Component
public class EfficiencyReportHandlerPM5 {
	 ...
	 * @throws IOException 
	 */
	public void createEfficiencyShiftReport(List<EfficiencyShiftDataPM5> datas,
		...
		//	util.addValue(row, col++, "", Workbook2007Util.Style.STYLE_BOLD_CENTER, rowHeight);
			...
			double toatlEff=0;	
			int sizeF=0;
				for (EfficiencyShiftDataPM5 dataGrand : datas) {
	...
	//Code Starts From Here Done By Roshan TAilor	
		...
		}
		{
			...
			double toatlEff=0;	
			int sizeB=0;
				for (EfficiencyShiftDataPM5 dataB : datas) {
		...
		}
		{
			...
			double toatlEff=0;	
			int sizeC=0;
				for (EfficiencyShiftDataPM5 dataC : datas) {
		...
		}
		{
			...
			double toatlEff=0;	
			int sizeD=0;
				for (EfficiencyShiftDataPM5 dataD : datas) {
