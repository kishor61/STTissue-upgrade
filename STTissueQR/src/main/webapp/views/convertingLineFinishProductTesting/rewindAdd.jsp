...
<title><spring:message code="app.name" /> - Converting Line Finish Product Testing Entry</title>
<style type="text/css">
...
<spring:url value="/convertinglinefinishproducttesting/save" var="saveUrl"/>
<spring:url value="/convertinglinefinishproducttesting/add" var="rewindUrl"/>
<spring:url value="/convertinglinefinishproducttesting/check" var="checkUrl"/>
<spring:url value="/convertinglinefinishproducttesting/setnocheck" var="checkRewindUrl"/>
<spring:url value="/convertinglinefinishproducttesting/delete" var="deleteUrl"/>

<spring:url value="/reel/findmatch" var="findmatchUrl"/>

<script type="text/javascript" src='<spring:url value="/resources/js/convertinglinefinishproducttestinger.js"/>'></script>
	...
	$(function(){
		...
		$('#loadBtn').click(function(){
			...
			if(date!='' & gradeCode!='-1' & reelNo!='-1'){
				location.href='${rewindUrl}/'+encodeURIComponent(gradeCode)+'/'+encodeURIComponent(reelNo);
			}else{
		...
		$('#rewindTaableBody input[name=customer]').focusout(saveFormData);
		...
		<div class="block3">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label"> Converting Line Finish Product Testing Entry</span>
				</div>
				<br>
						...
						<tr>
							...
							Reel:
							 <select name="reelNo" style="width: 70px;padding: 1px;">
								...
								<%-- <input type="text" value="${reelNo}" name="reelNo"> --%>
								...
								<!-- 	&nbsp; <button onclick="window.location.reload(true);">Refresh</button> -->
									...
									<security:authorize access="hasRole('ADMIN')">
									 &nbsp; <button onclick="location.href='<spring:url value="/convertinglinefinishproducttesting/add/back"/>'">Backdated Entry</button>
									</security:authorize>
								</c:if>
...
<!-- 																			Code Emds From Here Done By Roshan Tailor  -->
														...
														<input type="text" name="customer" value="ST Converting" readonly="readonly">				
													</td>
													<td> 
...
<spring:url value="/convertinglinefinishproducttesting/getCurrentData" var="getCurrentData" />
<script type="text/javascript">
	$(function(){
		$('#addMoreBtn').click(function(){
			...
			$('#rewindTaableBody input[name=customer]').unbind('focus');
			$('#rewindTaableBody input[name=customer]').focusout(saveFormData);
			
			$('#rewindTaableBody input[name=dirtCount]').focusout(function(){otherValidate($(this));});
			$('#rewindTaableBody input[name=absorbencySeconds]').focusout(function(){otherValidate($(this));});
// 			Code Starts From Here To Call The Ajax Using KeyUp, Done By Roshan Tailor Date :- 03/07/2015 MM/DD/YYYY
			$('#rewindTaableBody input[name=lvalue]').focusout(function(){otherValidate($(this));});
			$('#rewindTaableBody input[name=avalue]').focusout(function(){otherValidate($(this));});
			$('#rewindTaableBody input[name=bvalue]').focusout(function(){otherValidate($(this));});
// 			Code Ends Here Done By Roshan Tailor
...
<spring:url value="/convertinglinefinishproducttesting/rwindinfo" var="rewindInfoURL"/>
