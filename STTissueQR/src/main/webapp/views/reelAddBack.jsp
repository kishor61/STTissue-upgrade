...
<spring:url value="/reel/add/back" var="reelUrl"/>
...
<script type="text/javascript" src='<spring:url value="/resources/js/reel.js"/>'></script>
		...
		<div class="block3" id="block3">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Quality Data Backdated Entry-Reel Testing</span>
				</div>
				<br>
					...
					<table style="width: 100%;">
						<tr>
							...
							<!--  &nbsp; <button onclick="window.location.reload(true);">Refresh</button> -->
							 &nbsp; <button id="addMoreBtn">Add More Row</button>
