...
<div class="content-wrapper" style=" padding-top: 0px !important; background-color: #d4d8e559 !important;">
	...
	<div class="block3" style="overflow: auto;">
				...
				<div class="page-title">
					<span class="label">FRP Efficiency- Report</span>
				</div>
				...
				<div class="table-selector">
					<spring:url value="/frpefficiencyreport/view" var="viewURL" />
			...
			<c:if test="${fn:length(datas)>0}">
					...
					<table style="width: 100%;">
						<tr>
							<td style="text-align: center;"><spring:url
									value="/frpefficiencyreport/export" var="exportURL" />
				...
				<spring:url value="/frpefficiency/edit" var="editURL" />
