...
<title><spring:message code="app.name" /> - Reel Entry</title>
<style type="text/css">
...
<spring:url value="/reel/add" var="reelUrl"/>
<spring:url value="/reel/check" var="checkUrl"/>
<spring:url value="/reel/reelnocheck" var="checkReelUrl"/>
<spring:url value="/reel/delete" var="deleteUrl"/>

<spring:url value="/reel/save" var="saveUrl"/>
<spring:url value="/reel/findmatch" var="findmatchUrl"/>

<spring:url value="/reel/brightness/info" var="brightnessInfoUrl"/>
...
/* 	function bulkValidate(tb){
	...
	function sigmaMoistureCDValidate(tb){
		...
		var data={
				...
				minC:"${objective['GP179'].controlMin}",
		...
		<div class="block3" id="block3">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Quality Data Entry-Reel Testing</span>
				</div>
				<br>
				<div class="table-selector">
					...
					<table id="gradecodetable" style="width: 100%;">
						<tr>
							...
							<c:if test="${showForm}">
							 &nbsp; <button id="addMoreBtn" disabled>Add Row</button>
				...
				<div style="padding: 2px; overflow: auto;bottom: 0;left: 225px;right: 5px;top: 150px;">
					<c:if test="${showForm}">
...
<!-- 								Code Ends Here Done By Roshan Tailor -->
								<th style="width:100px;">Customer1</th>
								<th style="width:100px;">Customer2</th>
								<th style="width:100px;">Customer3</th>
...
<spring:url value="/reel/getCurrentData" var="getCurrentData" />	
<script type="text/javascript">
	$(function(reelNumber){
...
<spring:url value="/reel/reelinfo" var="reelInfoUrl"/>
...
<spring:url value="/reelreport/wrapperinfo" var="wrapperinfoURL"/>
<spring:url value="/reelreport/wrapperinfodetail" var="wrapperinfodetailURL"/>
