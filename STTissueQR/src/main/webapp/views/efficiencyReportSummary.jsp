		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Efficiency Summary- Report</span>
				</div>
				...
				<div class="table-selector">
					<spring:url value="/efficiencyreport/viewsummary" var="viewviewsummaryURL" />
...
<spring:url value="/efficiencyreport/exportsummary" var="exportURL" />
