...
<spring:url value="/winderbreakmonitoring/breakreason1/save" var="saveBreakReasonURL" />
<script>
function formSubmit()
{
...
<table border="1" style="border-collapse:collapse;border:2px solid #000000;color:#000000;width:50%" cellpadding="3" cellspacing="3">
	...
	<tr>
		...
		<td style="background-color: #FFF8DC;"><center><a href='<spring:url value="/winderbreakmonitoring/breakreasonsecondary/edit/${mbr.id}"/>'><b style="color: green;">Edit</b></a></center></td>
		<td style="background-color: #FFF8DC;"><center><a href='<spring:url value="/winderbreakmonitoring/breakreasonsecondary/delete/${mbr.id}"/>'><b style="color: red;">Delete</b></a></center></td>
	</tr>
	</c:forEach>
</table>
</center>
