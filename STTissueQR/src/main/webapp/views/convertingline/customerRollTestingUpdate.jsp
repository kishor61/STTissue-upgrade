...
<title><spring:message code="app.name" />- CUSTOMER ROLL TESTING Edit</title>
<style type="text/css">
		...
		<div class="block3">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Quality Data Edit-CUSTOMER ROLL TESTING</span>
				</div>
				<br>
...
<!-- 															Code Ends Here Done By Roshan Tailor 	 -->
													...
													<c:otherwise>
														<tr>
															...
															<td>
																<input type="text" value="ParentRollEntry"name="RollTesting" readonly="readonly">
															</td>
			...
			<c:choose>
				...
				<c:otherwise>
					<option value="${grade.gradeCode}">${grade.gradeCode}</option>
															...
															<td> 
																<input readonly="readonly" type="text" class="textbox" name="reel" value="${map['3']}"  autocomplete="off" style="width: 100px;">	
																<input readonly="readonly" type="hidden" class="textbox" style="text-transform: uppercase;" name="setNo" value="${map['4']}"  autocomplete="off">						
															</td>
															<%-- <td> 
...
<!-- 															Code Ends Here Done By Roshan Tailor -->
															<td> 
																...
																<select name="customer" style="width: 150px;padding: 1px;">
																	<option value="">Select</option>
													...
													<!-- Code For Finish Good Testing Starts From Here  -->
														<tr>
															<td>
																<input type="radio" name="rowCheckbox" value="${map['id']}"> 
															</td>
															...
															<td>
																<input type="text"value="Converted Roll"name="RollTesting" readonly="readonly">
															</td>
															...
															<td> 
																	 <select name="testinggradeCode" style="width: 110px;padding: 1px;">
																		<option value="">Select</option>
																			<c:forEach items="${grades}" var="grade">
																				<c:choose>
																					<c:when test="${grade.gradeCode == map['28']}">
																						<option value="${grade.gradeCode}" selected="selected">${grade.gradeCode}</option>
																					</c:when>
																					<c:otherwise>
																						<option value="${grade.gradeCode}">${grade.gradeCode}</option>
															...
															<td> 
																<input readonly="readonly" type="text" class="textbox" name="reel" value="${map['29']}"  autocomplete="off" style="width: 100px;">	
																<input readonly="readonly" type="hidden" class="textbox" style="text-transform: uppercase;" name="setNo" value="${map['30']}"  autocomplete="off">						
															</td>
															<%-- <td> 
																<input readonly="readonly" type="text" class="textbox" style="text-transform: uppercase;" name="setNo" value="${map['4']}"  autocomplete="off">						
															</td> --%>
															<td> 
																<input type="text" class="textbox ${map['31C']}" name="testingactualBasisWt" value="${map['31']}"  autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox ${map['32C']}" name="testingbulk" value="${map['32']}"  autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox ${map['33C']}" name="testingmdTensile" value="${map['33']}"  autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox ${map['34C']}" name="testingcdTensile" value="${map['34']}"  autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox ${map['35C']}" name="testingmdStretch" value="${map['35']}"  autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox ${map['36C']}" name="testingmdcdTensileRatio" value="${map['36']}"  autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox ${map['37C']}" name="testingmdWetTensile" value="${map['37']}"  autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox ${map['38C']}" name="testingcdWetTensile" value="${map['38']}"  autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox ${map['39C']}" name="testingcdTensileRatio" value="${map['39']}" autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox ${map['40C']}" name="testingbrightness" value="${map['40']}"  autocomplete="off">						
															</td>
															
															<td> 
																<input type="text" class="textbox ${map['41C']}" name="testingdirtCount" value="${map['41']}" autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox ${map['42C']}" name="testingabsorbencySeconds" value="${map['42']}" autocomplete="off">						
															</td>
<!-- 															Code Starts From Here Done By Roshan Tailor Date :- 03/10/2015  MM/DD/YYYY  -->
<!-- 															With The Help Of ${map['16C']} Green Color Will Be Apper -->
															<td> 
																<input type="text" class="textbox  " name="testinglvalue" value="${map['43']}" autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox " name="testingavalue" value="${map['44']}" autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox " name="testingbvalue" value="${map['45']}" autocomplete="off">						
															</td>				
<!-- 															Code Ends Here Done By Roshan Tailor -->
															<td> 
																
																
																<select name="testingcustomer" style="width: 150px;padding: 1px;">
																	<option value="">Select</option>
																		<c:forEach items="${customers}" var="customer">
																			<c:set var="custName" value="${map['46']}"/>
																			<c:choose>
																				<c:when test="${customer == custName}">
																					<option value="${customer}" selected="selected">${customer}</option>
																				</c:when>
															...
															<td> 
																<input type="text" name="testingremarks" value="${map['47']}">						
															</td>
														</tr>
														<!-- Code For Finish Good Testing Ends Here -->
													</c:otherwise>
												</c:choose>
				...
				&nbsp;
				<button id="editBtn">Edit Row</button>
				<br>
...
<spring:url value="/convertinglinecustomerrolltesting/update" var="updateRewindUrl"/>
<script type="text/javascript">
...
<spring:url value="/convertinglinecustomerrolltesting/add/editdata/by/" var="addrowURL"/>
<script>
$('#editBtn').click(function(){
	//var trRow=$(this).parent().parent();
	var reelId=$('#tableBody input[type=radio]:checked').val();
	//var gradeCode=trRow.find('select[name=gradeCode]').val();
	//var reelNo=trRow.find('input[name=reel]').val();
	//var date=trRow.find('input[name=date]').val();+
	alert(reelId);
	//alert(date);
	//alert(date);
	window.location.href='${addrowURL}/'+encodeURIComponent(reelId);
});
</script>
</body>
</html>
