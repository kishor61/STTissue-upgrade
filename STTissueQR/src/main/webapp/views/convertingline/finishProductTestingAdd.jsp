...
<title><spring:message code="app.name" /> - Finish Product Testing</title>
<style type="text/css">
...
<spring:url value="/convertinglinefinishproducttesting/add" var="finalProductTestingUrl"/>
		...
		<div class="block3">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Converting Line 171 - Finish Product Testing</span>
				</div>
				<br>
					...
					<table style="width: 100%;">
						<tr>
							...
							<%-- <select name="reelNo" style="width: 70px;padding: 1px;">
								...
								<input type="text" name="reelNo" value="">
