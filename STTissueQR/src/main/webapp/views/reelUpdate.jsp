...
// 					Code Ends Here Done By Roshan Tailor
	...
	$("#tableBody tr input[type=text],#tableBody tr select[name=customer],#tableBody tr select[name=customer1],#tableBody tr select[name=customer2],#tableBody tr select[name=gradeCode]").focusout(function(){
		var val=$(this).val();
