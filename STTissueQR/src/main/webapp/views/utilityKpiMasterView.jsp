		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="table-selector">
					...
					<spring:url value="/utilitykpimasterreport/view/data"
						var="viweDataURL" />
								...
								<td><input type="submit" id="viewBtn" value="View">
									...
									<input type="button" id="exportRowBtn" value="Export">
 									...
 									<c:if test="${page eq 'K'}">
										...
										<a href='<spring:url value="/utilitykpimasterreport/exportkpi/pdf?type=${page}&sdate=${sdate}&edate=${edate}"/>' target="_blank">PDF</a>
				...
				<div>
					...
					<!-- Utility Page -->
					<c:if test="${page eq 'U'}">
						<jsp:include page="utilityKpiMasterViewUtility.jsp" />
					</c:if>

					<!-- Master Page -->
					<c:if test="${page eq 'M'}">
						<jsp:include page="utilityKpiMasterViewMaster.jsp" />
					</c:if>

					<!-- KPI -->
					<c:if test="${page eq 'K'}">
						<jsp:include page="utilityKpiMasterViewKPI.jsp" />
					</c:if>
