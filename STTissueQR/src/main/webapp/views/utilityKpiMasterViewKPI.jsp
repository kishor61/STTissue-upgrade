...
<spring:url value="/utilitykpimaster/edit"  var="editUrl"/>
...
<spring:url value="/utilitykpimasterreport/kpiemail"  var="kpiemailURL"/>
<script type="text/javascript">
	$(function(){
...
<spring:url value="/utilitykpimasterreport/exportkpi" var="exportDataURL"/>
...
<table id="kpiTable" class="table" style="width: auto;; margin: auto; font-size: 12px;">
	...
	<tbody>
		...
		<tr>
			...
			<td style="width: 60px;"><div><fmt:formatNumber type="number" maxFractionDigits="0" value="${data['31']}" /></div></td>
			<td style="width: 60px;"><div><fmt:formatNumber type="number" maxFractionDigits="0" value="${data['32']}" /></div></td>
			...
			<%-- <fmt:parseNumber var="i" type="number" value="${data['30']+data['13']}" maxFractionDigits="2"/> --%>
			 ...
			 <fmt:formatNumber var="i" type="number" maxFractionDigits="2" value="${data['30']+data['13']}" />
