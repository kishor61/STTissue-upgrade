...
<title><spring:message code="app.name" />- Rewinder Report Edit</title>
<style type="text/css">
		...
		<div class="block3">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Quality Data Edit-Rewinder Testing</span>
				</div>
				<br>
...
<spring:url value="/rewind/update" var="updateRewindUrl"/>
<script type="text/javascript">
