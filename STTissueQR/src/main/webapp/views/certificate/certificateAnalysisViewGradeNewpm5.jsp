		...
		<c:if test="${fn:length(grades) gt 0 }">
			<c:forEach items="${grades}" var="grade">
				<tr>
					...
					<td style="text-align: center;"><a href='<spring:url value="/certificateanalysis/load/dataNewpm5?sdate=${sdate}&edate=${edate}&customer=${customer}&grade=${grade}"/>'>VIEW</a> </td>
				</tr>	
			</c:forEach>
		</c:if>
