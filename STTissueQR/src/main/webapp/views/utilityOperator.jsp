...
<div class="page-box" id="loadPage">
	...
	<div class="container">
		...
		<div class="block3" style="overflow: auto;">
			...
			<spring:url value="/UtilityOperator/save" var="viewURL"/>
						...
						<tr>
						  ...
						  <tr>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="wrapperFoxCol1" ${data.wrapperFoxCol1 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						 ...
						 <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="wrapperFoxCol2" ${data.wrapperFoxCol2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <input type="radio" value="true" ${data.wrapperFoxCol3 == 'true' ? 'checked' : ''} name="wrapperFoxCol3"/> Yes 
						     <input type="radio" value="false" ${data.wrapperFoxCol2 == 'false' ? '' : ''} name="wrapperFoxCol3"/>No   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						     ...
						     <input type="radio" value="false"  ${data.wrapperFoxCol4 == 'false' ? '' : ''} name="wrapperFoxCol4"/>No    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
						   ...
						   --%>
						    ...
						    <input type="radio" value="false"  ${data.wrapperFoxCol5 == 'false' ? '' : ''} name="wrapperFoxCol5"/>No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
						  ...
						  <tr>
						    <td class="tg-yw4l"  >TOWER</td>
						    	...
						    	<input type="radio" value="false" ${data.wrapperWuftechCol1 == 'false' ? '' : ''} name="wrapperWuftechCol1"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l"  >STRETCH WRAP DRIVE ASSEMBLY</td>
						    	...
						    	<input type="radio" value="false" ${data.wrapperWuftechCol2 == 'false' ? '' : ''} name="wrapperWuftechCol2"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l">CONTROL PANEL</td>
						    	...
						    	<input type="radio" value="false" ${data.wrapperWuftechCol3 == 'false' ? '' : ''} name="wrapperWuftechCol3"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Motor - Overheating</td>
						    	...
						    	<input type="radio" value="false" ${data.wrapperWuftechCol4 == 'false' ? '' : ''} name="wrapperWuftechCol4"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    <td class="tg-yw4l"  >Motor - Abnormal Sound</td>
						    	...
						    	<input type="radio" value="false" ${data.wrapperWuftechCol5 == 'false' ? '' : ''} name="wrapperWuftechCol5"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    <td class="tg-yw4l"  >TURN TABLE </td>
						    	...
						    	<input type="radio" value="false" ${data.wrapperWuftechCol6 == 'false' ? '' : ''} name="wrapperWuftechCol6"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <input type="radio" value="false" ${data.scaleCol1 == 'false' ? '' : ''} name="scaleCol1"/>No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <input type="radio" value="false" ${data.scaleCol2 == 'false' ? '' : ''} name="scaleCol2"/>No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <input type="radio" value="false" ${data.scaleCol3 == 'false' ? '' : ''} name="scaleCol3"/>No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <input type="radio" value="false" ${data.scaleCol4 == 'false' ? '' : ''} name="scaleCol4"/>No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
