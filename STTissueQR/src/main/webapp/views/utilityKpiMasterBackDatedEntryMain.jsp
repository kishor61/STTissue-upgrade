...
<spring:url value="/utilitykpimaster/masterbackdatedentry/report" var="oldDataURL" />
<script type="text/javascript">
$(function(){
		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">PULP AND UTILITY CONSUMPTION REPORT- Back Dated Entry</span>
				</div>
				<br>
				...
				<div>
					...
					<!-- Master Page -->
					<c:if test="${page eq 'M'}">
						<jsp:include page="utilityKpiMasterNewMaster_backDateData.jsp" />
					</c:if>
