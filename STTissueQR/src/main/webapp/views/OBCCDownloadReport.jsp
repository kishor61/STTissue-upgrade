...
<spring:url value="/OBCCReport/view/report/data/detailedreport/exportPercentage/email" var="emailURL"/>
<script type="text/javascript">
	$(function(){
...
<body>
	...
	<div class="container">
		...
		<spring:url value="/OBCCReport/view/report/data/detailedreport/exportPercentage" var="viewURL"/>
