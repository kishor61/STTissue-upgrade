...
<spring:url value="/wrapperVsMachineSummaryReport/email" var="emailURL"/>
	...
	$(function(){
		...
		$('#edate,#sdate').datepicker({
		 ...
		 $('#sendMailBtn').click(function(){
			...
			var btn=$(this);
			if(confirm('Do you want to send Machine Vs Wrapper Report? ')){
		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">ST Tissue - Machine Vs Wrapper Report</span>
				</div>
				<br>
...
<spring:url value="/wrapperVsMachineSummaryReport/export" var="exportURL"/>
