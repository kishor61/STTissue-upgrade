...
<spring:url value="/productionwarpreport/email/gradenhoursWithSummary" var="emailURL"/>
		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">ST Tissue - Grade And Hours Report - With Summary</span>
				</div>
				<br>
...
<spring:url value="/productionwarpreport/export/gradenhoursWithSummary" var="exportURL"/>
