...
<spring:url value="/productionwarpreport/email" var="emailURL"/>
		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">ST Tissue - Wrapper Production By Date</span>
				</div>
				<br>
...
<spring:url value="/productionwarpreport/dataByDate/export" var="exportURL"/>
