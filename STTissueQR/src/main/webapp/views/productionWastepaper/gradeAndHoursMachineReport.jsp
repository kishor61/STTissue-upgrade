...
<spring:url value="/productionreport/email/gradenhours" var="emailURL"/>
		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">ST Tissue - Grade And Hours Machine Report</span>
				</div>
				<br>
...
<spring:url value="/productionreport/export/gradenhours" var="exportURL"/>
