...
<spring:url value="/winderbreakmonitoring/save" var="saveURL" />
<spring:url value="/winderbreakmonitoring/report/delete" var="deletewinderDataURL" />
<spring:url value="/winderbreakmonitoring/view" var="oldDataURL" />
<spring:url value="/winderbreakmonitoring//timedurtation" var="timedurtationURL" />
...
function saveData(jq){
	...
	var BreakAt=tr.find('input[name=BreakAt]').val();
...
<table id="yielddatatable" class="table" style="width: auto;">
	<thead style="text-align: center;">
		<tr>
			...
			<td rowspan="2"><b>Breaks/<br>Stops</b></td>
	...
	<c:if test="${fn:length(moniterdatas) eq 0 }">
		<tr>
			...
			<td><input type="text" name="Reel" style="width: 58px;" value="" autocomplete="off"></td>
			<td><input type="text" name="SetNo" style="width: 58px;" value="" autocomplete="off"> </td>
			<td><input type="text" name="BreakAt" style="width: 58px;" value="" autocomplete="off"> </td>
	...
	<c:if test="${fn:length(moniterdatas)> 0 }">
		<c:forEach items="${moniterdatas}" var="moniterdatas">
			...
			<td><input type="text" name="Reel" style="width: 58px;" value="${moniterdatas.reel}" autocomplete="off"></td>
			<td><input type="text" name="SetNo" style="width: 58px;" value="${moniterdatas.setNo}" autocomplete="off"> </td>
			<td><input type="text" name="BreakAt"  style="width: 58px;" value="${moniterdatas.breakAt}" autocomplete="off"> </td>
		...
		<select name="Stopmin">
			...
			<td>
				...
				<select name="Reasonforbreak">
					...
					<c:forEach items="${moniterbreakreason}" var="mbrare">
						<c:choose>
							<c:when test="${mbrare.reasonforbreak eq moniterdatas.reasonforbreak}">
