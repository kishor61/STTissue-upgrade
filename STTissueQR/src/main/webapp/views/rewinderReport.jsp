...
<html>
<head>
<title><spring:message code="app.name" /> - Rewinder Report</title>
		...
		<div class="block3">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Quality Report-Rewinder Testing</span>
				</div>
...
<spring:url value="/rewindreport/view/update" var="rewindReportEdit"/>
