		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Chemical - Data Entry</span>
				</div>
				<br>
...
<table class="table" style="margin: auto;width: 800px;">
	<thead>
		<tr>
			<td colspan="8">
				<b>Date</b>
				<input type="text" name="date" style="width: 90px;"readonly="readonly" value="${date}">
			...
			<tr>
				...
				<td>
					<div>${ch1.chemicalCode}
						<input type="hidden" name="id" value="" style="width: 30px;">
						<input type="hidden" name="cid" value="${ch1.id}">
					</div>
				</td>
				<td class="tdgray" style="width: 80px;"></td>
				<td style="width: 80px;"><input type="text" name="consumption"  style="width: 78px;"></td>
				<td>${ch1.unit}</td>
