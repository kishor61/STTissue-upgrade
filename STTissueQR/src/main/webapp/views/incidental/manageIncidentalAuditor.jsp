...
<spring:url value="/incidentaluser/edit/status" var="statusURL" />
<script type="text/javascript">
		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Manage Incidental Auditor</span>
				</div>
				<br>
				<div class="table-selector">
					<spring:url value="/incidentaluser/save" var="saveURL"/>
						...
						<table>
							<tr>
								...
								<td>
									...
									<spring:url value="/incidentaluser/manage" var="newURL" />
	...
	<tbody>
		<c:forEach items="${auditors}" var="user" varStatus="i">
			<tr>
				...
				<td>
					<a href='<spring:url value="/incidentaluser/edit/${user.id}"></spring:url>'>Edit</a>
				</td>
				<td>
