...
<spring:url value="/reelreport/scacoating/view/report" var="csaCoatingReportView"/>
<spring:url value="/reelreport/scacoating/view/report/export" var="csaCoatingReportExport"/>
...
$(function(){
	...
	$('#viewBtn').click(function(){
		$('#reelReportForm').attr('action','${csaCoatingReportView}');
	...
	$('#exportBtn').click(function(){
		$('#reelReportForm').attr('action','${csaCoatingReportExport}');
		$('#reelReportForm').attr('target','_blank');
		$('#reelReportForm').submit();
		return false;
	});
