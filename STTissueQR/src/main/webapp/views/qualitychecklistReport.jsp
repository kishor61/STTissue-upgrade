...
<spring:url value="/qulitycheck_pm6/qaulitychecklist/delete" var="deletewinderDataURL" />
<spring:url value="/qulitycheck_pm6/qaulitychecklist/data/edit" var="editIdDataURL" />
<script type="text/javascript">
$(function(){
	...
	<div class="container">
		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<spring:url value="/qulitycheck_pm6/qualitychecklist/report/show" var="viewURL"/>
...
<form id="exportFrom" action='<spring:url value="/qulitycheck_pm6/productspecificationsignoffsheet/report/show/export"/>' method="get" style="display:none; " target="_blank">
