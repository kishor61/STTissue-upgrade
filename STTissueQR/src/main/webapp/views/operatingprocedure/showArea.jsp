...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="content-wrapper" style=" padding-top: 0px !important; background-color: #d4d8e559 !important;">
		<div class="content-header" style="padding-top: 10px !important;padding-bottom: 0px !important;line-height: 0px !important;">
			<h5 style="text-align:center; font-weight:bold;color:#343e70;">PROCEDURES Area(s)</h5>
		</div>
...
<center>
					<div class="divTable" style="border: 1px solid #000;">
						<div class="divTableBody">
							<div class="divTableRow" style="background-color: #ffe00094;">
								<div class="divTableCell" style="font-size:  21px;">Select The Area</div>
							</div>
							<c:forEach items="${areas}" var="are">
								<div class="divTableRow" style="background-color: #9496ce94;">
									<div class="divTableCell">
										<b><a href='<spring:url value="/operatingprocedure/showMainCatogoeryByAreaWise?aera=${are.area}"/>'>${are.area}</a>	</b>
									</div>
								</div>
							</c:forEach>
						</div>
