...
<spring:url value="/wastepaperreportbyvendorandgrade/load" var="viewdataURL" />
<spring:url value="/wastepaperreportbyvendorandgrade/export" var="byGradeAndVendorExportURL"/>
		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Waste Paper Report By Vandor And Grade</span>
				</div>
				<div class="table-selector">
					...
					<table>
						...
						<form action="${viewdataURL}" method="get">
						 ...
						 <c:if test="${viewpage}">
								<form action="${byGradeAndVendorExportURL}" method="POST">
										...
										<td><input type="hidden" name="vendor" value="${srchdvendor}"></td>
...
<table id="barcodedatatable" class="table" style="width: auto;">
	...
	<tr>
				<td></td>
				<td></td>
				<td><b>${wpbvng.vandorName} Total</b></td>
				<td></td>
				<td></td>
				<td><b>${wpbvng.itemDescription} Total</b></td>
				<td><fmt:formatNumber value="${wpbvng.totalbales}" var="totalbales" maxFractionDigits="2"/><b>${totalbales}</b></td>
				<td><fmt:formatNumber value="${wpbvng.netTons}" var="netTons" maxFractionDigits="2"/><b>${netTons}</b></td>
				<td><fmt:formatNumber value="${wpbvng.pricePerTon}" var="pricePerTon" maxFractionDigits="2"/><b>${pricePerTon}</b></td>
				...
				<td></td>
				<td></td>
				<td><fmt:formatNumber value="${wpbvng.freightInvoiced}" var="freightInvoiced" maxFractionDigits="2"/><b>${freightInvoiced}</b></td>
				<td><fmt:formatNumber value="${wpbvng.freightCHBK}" var="freightCHBK" maxFractionDigits="2"/><b>${freightCHBK}</b></td>
				<td><fmt:formatNumber value="${wpbvng.grandTotal}" var="grandTotal" maxFractionDigits="2"/><b>${grandTotal}</b></td>
				<td></td>
				<td></td>
	</tr>	
	</table>
