...
<spring:url value="/pm5centerline/print" var="printURL"/>
<%-- <spring:url value="/centerline/getencodedgrade" var="getGradeCodeURL"/> --%>
<spring:url value="/pm5centerline/print/grade" var="printGradeURL"/>
...
<script type="text/javascript" src='<spring:url value="/dist/js/old/centerlinePM5.js"/>'></script>
...
<style>
	...
	.print-button:focus {
	    outline: none;
	    box-shadow: 0 0 10px rgba(72, 144, 226, 0.5); /* Blue glow on focus */
	}

	/* Add some spacing for the td */
	td {
	    padding: 20px 10px; /* Increase padding around the button */
	}
	</style>
</head>
...
<div id="printDiv">	
	<div class="content-wrapper" style=" padding-top: 0px !important; background-color: #d4d8e559 !important;">
		<div class="content-header" style=" padding-top: 10px !important; padding-bottom: 0px !important; line-height: 0px !important;">
			<h1 class="report-title">Centerline Data Entry For PM5</h1>
		</div>
		...
		<div class="block3" style="overflow: auto;">
			...
			<table style="width: 100%;">
					<tr>
						...
						<td align="center">
						    <a href="#" id="printBtn" target="_blank" class="print-button">Print Page</a>
						</td>
...
<div style="padding: 10px;" id="printDiv">
	...
	<thead>	
		...
		<tr>
			...
			<td style="" colspan="2">Basis weight target</td>
			<td style="width: 80px;" class="vcolor"></td>
			<td style="width: 60px;"><input class="number" type="text" name="qcsBasisWtTarget" tabindex="6"> </td>
			<td style="width: 70px;">#</td>
			<td style="width: 135px;">Moisture target</td>
			<td style="width: 80px;" class="vcolor"></td>
			<td style="width: 60px;"><input  class="number" type="text" name="moisturetarget" tabindex="12"> </td>
			<td style="width: 70px;">%</td>
		</tr>
		
		<tr>
	
			<td style="" colspan="2">Yankee MAP flow</td>
			<td style="width: 80px;" class="vcolor"></td>
			<td style="width: 60px;"><input class="number" type="text" name="yankeemapflow" tabindex="6"> </td>
			<td style="width: 70px;">mg/m2</td>
			
			<td style="width: 135px;">Machine Chest Pump Speed</td>
			<td style="width: 80px;" class="vcolor"></td>
			<td style="width: 60px;"><input  class="number" type="text" name="machinechestpumpspeed" tabindex="12"> </td>
			<td style="width: 70px;">rpm</td>
		</tr>
		...
		<tr>
			...
			<td style="width: 135px;">Yankee Release Flow</td>
			<td style="width: 80px;" class="vcolor"></td>
		...
		<tr>
			...
			<td colspan="2">Jet/Wire Ratio</td>
			<td class="vcolor"></td>
		...
		<tr>
			...
			<td colspan="2">Yankee Steam Pressure</td>
			<td class="vcolor"></td>
		...
		<tr>
			...
			<td>psi</td> -->
			<td colspan="2">Fan Pump speed</td>
			<td class="vcolor"></td>
		...
		<tr>
			...
			<td colspan="2">Felt Passivator Flow</td>
			<td class="vcolor"></td>
		...
		<!-- <tr>
			...
			<td colspan="2">Horizontal slice local</td>
			<td class="vcolor"></td>
		...
		<tr>
			...
			<td colspan="1">DE Hood Temperature</td>
			<td class="vcolor"></td>
		...
		<tr>
			<td colspan="2">Wet Strength Flow</td>
			<td class="vcolor"></td>
		...
		<tr>
			...
			<td colspan="2">SPR Loading Front</td>
			<td class="vcolor"></td>
			<td><input  class="number" type="text" name="SPRLoadingFront" tabindex="70"> </td>
			<td>pli</td>
			
			<td colspan="1">SPR Loading Back</td>
			<td class="vcolor"></td>
			<td><input  class="number" type="text" name="SPRLoadingBack" tabindex="34"> </td>
			<td>pli</td>
		...
		<tr>
			...
			<td colspan="2">Pick Up Roll Vacuum</td>
			<td class="vcolor"></td>
			<td><input  class="number" type="text" name="PickUpRollVacuum" tabindex="35"> </td>
			<td>in Hg</td>
			
			<td colspan="1">Uhle Box Vacuum</td>
			<td class="vcolor"></td>
			<td><input  class="number" type="text" name="UhleBoxVacuum" tabindex="34"> </td>
			<td>in Hg</td>
			
		</tr>
		<tr>
			
			<td colspan="2">SPR Vacuum</td>
			<td class="vcolor"></td>
			<td><input  class="number" type="text" name="SPRVacuum" tabindex="35"> </td>
			<td>in Hg</td>
		
			<td colspan="1">Primary Screen Reject Flow</td>
			<td class="vcolor"></td>
			<td><input  class="number" type="text" name="PrimaryScreenRejectFlow" tabindex="34"> </td>
			<td>gpm</td>
		</tr>
		...
		<tr>
			...
			<td colspan="2">Blend Chest Cy</td>
			<td class="vcolor"></td>
			<td><input  class="number" type="text" name="BlendChestCy" tabindex="35"> </td>
			<td>%</td>
		
			<td colspan="1">Refiner # 1 power</td>
			<td class="vcolor"></td>
			<td><input  class="number" type="text" name="Refiner1Power" tabindex="34"> </td>
			<td>kw</td>
		</tr>
		
		<tr>
			
			<td colspan="2">Refiner # 2 Power</td>
			<td class="vcolor"></td>
			<td><input  class="number" type="text" name="Refiner2Power" tabindex="35"> </td>
			<td>kw</td>
		
			<td colspan="1">Refiner # 1 Inlet Cy</td>
			<td class="vcolor"></td>
			<td><input  class="number" type="text" name="Refiner1InletCy" tabindex="34"> </td>
			<td>%</td>
		</tr>
		
		<tr>
			
			<td colspan="2">Refiner # 2 Inlet Cy</td>
			<td class="vcolor"></td>
			<td><input  class="number" type="text" name="Refiner2InletCy" tabindex="35"> </td>
			<td>%</td>
