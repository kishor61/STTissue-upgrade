...
$(function(){
	...
	function operatorSelect(value)
	{
		...
		if(crew!='-1' && position!='-1')
			...
			if(position == 'R2')
			{
				location.href="./viewoperator?shift="+value+"&position="+position+"&date="+date+"&operatorname="+operatorname+"&crew="+crew;
			}
...
<body>
	...
	<div class="container">
		...
		<c:if test="${data.position == 'R2'}">	
			<spring:url value="/pm5operatorCareCheckList/save" var="viewURL"/>
		</c:if>	
