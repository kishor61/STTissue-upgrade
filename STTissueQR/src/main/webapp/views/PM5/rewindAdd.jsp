...
<title><spring:message code="app.name" /> - Rewinder Entry PM5</title>
<style type="text/css">
...
<spring:url value="/pm5rewind/save" var="saveUrl"/>
<spring:url value="/pm5rewind/add" var="rewindUrl"/>
<spring:url value="/pm5rewind/check" var="checkUrl"/>
<spring:url value="/pm5rewind/setnocheck" var="checkRewindUrl"/>
...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="content-wrapper" style=" padding-top: 0px !important; background-color: #d4d8e559 !important;">
		<div
		          ...
		          "
		><h5 style="text-align:center; font-weight:bold;color:#343e70;">Quality Data Entry-Rewind Testing For PM5</h5></div>
							...
							<select name="reelNo" style="width: 70px;padding: 1px;">
								...
								<!-- 	&nbsp; <button onclick="window.location.reload(true);">Refresh</button> -->
									...
									<security:authorize access="hasRole('ADMIN')">
									 &nbsp; <button onclick="location.href='<spring:url value="/rewind/add/back"/>'"class="btn btn-secondary btn-sm">Backdated Entry</button>
									</security:authorize>
								</c:if>
					...
					<table class="table">
						<thead style="font-size: 11px;">
							...
							<tr>
								...
								<th style="width:80px;">Bulk At Winder <br>  mils /8 ply</th>
...
<spring:url value="/pm5rewind/getCurrentData" var="getCurrentData" />
<script type="text/javascript">
	$(function(){
...
<spring:url value="/pm5rewind/rwindinfo" var="rewindInfoURL"/>
