...
<div>
<spring:url value="/pm5utilitykpimaster/savekpidate"  var="saveURL"/>
<spring:url value="/pm5utilitykpimaster/deletekpirecordabledate"  var="deleteURL"/>
...
<table id="kpiRdTable" style="margin: auto;">
	<tr>
		...
		<td>
			...
			&nbsp;&nbsp;
			<spring:url value="/pm5utilitykpimasterreport/view" var="viewReportURL"/>
