		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">PM5 Production - Report</span>
				</div>
				<br>
				<div class="table-selector">
				
				<spring:url value="/pm5productionreport/viewsummary/data" var="viewURL"/>
...
<spring:url value="/pm5productionreport/0" var="emailURL"/>
<script type="text/javascript">
	$(function(){
		...
		$('#sendMailBtn').click(function(){
			...
			if(confirm('Do you want to send PM5 PRODUCTION - REPORT for :'+date)){
...
<spring:url value="/pm5productionreport/exportsummary" var="exportURL"/>
...
<table id="reportTable1" class="table" style="width: 600px; margin: auto; font-size: 12px;">
	<thead>
		<tr class="trobjrow">
			<th colspan="7">PM5 Machine Production - ${date}</th>
		</tr>
		<tr>
			<th>Date</th>
			<th>Grade</th>
...
<thead>
		<tr class="trobjrow">
			<th colspan="7">PM5 Machine Sheet Break Summary - ${date}</th>
		</tr>
		<tr>
			<th></th>
			<th>Shift</th>
...
<!-- Code Ends Here Done By Roshan Tailor For Machine Producation -->
	<thead>
		<tr class="trobjrow">
			<th colspan="7">PM5 Wrapped Production  - ${date}</th>
		</tr>
		<tr>
			<th>Date</th>
			<th>Shift</th>
...
<table id="reportTable1" class="table" style="width: 600px; margin: auto; font-size: 12px;">
	<thead>
		<tr class="trobjrow">
			<th colspan="7">PM5 Wrapped Sheet Break Summary - ${date}</th>
		</tr>
		<tr>
				...
				<c:forEach items="${datas['rollbreakinfo']}" var="rbinfo">
					<c:if test="${fn:containsIgnoreCase(rbinfo.shift,'Day') }">
						...
						<tr class="trrowgray">
							...
							<td style="width: 45px;"><center>Total</center></td>
							<td style="width: 115px;"><center><div><b>${totalRoll}</b></div></center></td>
							<td style="width: 115px;"><center><div><b>${totalrollsproduce}</b></div></center></td>
