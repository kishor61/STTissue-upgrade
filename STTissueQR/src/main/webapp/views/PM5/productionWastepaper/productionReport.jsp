...
<spring:url value="/pm5productionreport/report/email" var="emailURL"/>
<script type="text/javascript">
	$(function(){
	...
	<div class="container">
		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<spring:url value="/pm5productionreport/view/data" var="viewURL"/>
...
<spring:url value="/pm5productionreport/export" var="exportURL"/>
