...
<spring:url value="/pm5productionreport/breakfreeproducation/showdata/email" var="emailURL"/>
<script type="text/javascript">
	$(function(){
		$('#mailBtn').click(function(){
			...
			if(confirm('Do You Want To Send Machine Break Free Production Mail For PM5')){
		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Break Free Percentage Production Report For PM5</span>
				</div>
				<div class="table-selector">
					<spring:url value="/pm5productionreport/breakfreeproducation/showdata" var="viewURL"/>
...
<c:if test="${export}">
<form id="exportFrom" action='<spring:url value="/pm5productionreport/breakfreeproducation/showdata/export"/>' method="get" style="display:none; " target="_blank">
	<input type="hidden" name="sdate" value="${sdate}">
	<input type="hidden" name="edate" value="${edate}">
	<input type="hidden" name="shift" value="${shift}">
</form>
<form id="mailFrom" action='<spring:url value="/pm5productionreport/breakfreeproducation/showdata/mail"/>' method="get" style="display:none;">
	<input type="hidden" name="sdate" value="${sdate}">
	<input type="hidden" name="edate" value="${edate}">
	<input type="hidden" name="shift" value="${shift}">
</form>
