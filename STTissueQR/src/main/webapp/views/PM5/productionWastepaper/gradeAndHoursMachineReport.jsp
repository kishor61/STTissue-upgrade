...
<spring:url value="/pm5productionreport/email/gradenhours" var="emailURL"/>
<script type="text/javascript">
	$(function(){
		...
		$('#sendMailBtn').click(function(){
			...
			var btn=$(this);
			if(confirm('Do you want to send Grade and Hours Report For PM5 ? ')){
		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">ST Tissue - Grade And Hours Machine Report For PM5</span>
				</div>
				<br>
...
<spring:url value="/pm5productionreport/export/gradenhours" var="exportURL"/>
