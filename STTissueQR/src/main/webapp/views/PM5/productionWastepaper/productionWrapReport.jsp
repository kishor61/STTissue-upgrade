		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">PM5 Tissue Wrapped Tons - Report</span>
				</div>
				<br>
				<div class="table-selector">
				
				<spring:url value="/pm5productionwarpreport/view/data" var="viewURL"/>
...
<spring:url value="/pm5productionwarpreport/export" var="exportURL"/>
...
<table class="table" style="margin: auto; font-size: 12px; width: 700px;">
	...
	<thead>
		<tr class="trobjrow">
			<th colspan="10">PM5 TISSUE Wrapped Tons with Machine Production ${reportFrom} - ${reportTo}
			 </th>
		</tr>
		<tr>
...
<table id="reportTable" class="table" style="margin: auto; font-size: 12px; width: 700px;">
	...
	<thead>
		<tr class="trobjrow">
			<th colspan="10">ST Tissue LLC, PM5 TISSUE WRAPPED TONS -
