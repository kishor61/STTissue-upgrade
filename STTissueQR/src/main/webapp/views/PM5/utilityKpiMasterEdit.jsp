					...
					<table style="margin: auto;">
						<tr>
							...
							<td>&nbsp;
								...
								<spring:url value="/pm5utilitykpimasterreport/view/data" var="backPath"/>
...
<!-- Utility Page -->
<c:if test="${page eq 'U'}">
	<jsp:include page="../PM5/utilityKpiMasterEditUtility.jsp" />
</c:if>

<!-- Master Page -->
<c:if test="${page eq 'M'}">
	<jsp:include page="../PM5/utilityKpiMasterEditMaster.jsp" />
</c:if>
