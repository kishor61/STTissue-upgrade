		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Efficiency Summary By Shift - DCS For PM5</span>
				</div>
				<div class="table-selector">
				<form action='<spring:url value="/pm5efficiencyreport/byDcs/report/view"></spring:url>' method="get">
...
<form id="exportForm" action='<spring:url value="/pm5efficiencyreport/byDcs/report/export"></spring:url>' method="post">
