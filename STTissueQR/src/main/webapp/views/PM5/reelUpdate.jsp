...
<title><spring:message code="app.name" />- Reel Report Edit PM5</title>
<style type="text/css">
		...
		<div class="block3">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Quality Data Edit-Reel Testing PM5</span>
				</div>
				<br>
					...
					<table class="table">
						<thead style="font-size: 12px;">
							...
							<tr>
								...
								<th style="width:80px;">Dry Strength Flow<br>(gpm)</th>
												...
												<c:choose>
													<c:when test="${obj eq 'OBJECTIVES'}">
														...
														<td></td>
															...
															<td  class="trobjrow"><fmt:formatNumber value="${map['34'] - 0.0000}" maxFractionDigits="0"/></td>
															...
															<td  class="trobjrow">${map['29']}</td>
															<td  class="trobjrow">${map['30']}</td>
															<td  class="trobjrow">${map['31']}</td>
			...
			<c:choose>
				...
				<c:otherwise>
					<option value="${grade.gradeCode}">${grade.gradeCode}</option>
															...
															<td> 
																<input type="text" class="textbox ${map['34C']}" name="finchCup" value="${map['34']}"  autocomplete="off">						
															</td>
															...
															<td> 
																<input type="text" class="textbox" name="akd" value="${map['29']}"  autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox" name="wetstrength" value="${map['30']}"  autocomplete="off">						
															</td>
															<td> 
																<input type="text" class="textbox" name="drystrengthflow" value="${map['31']}"  autocomplete="off">						
															</td>
...
<!-- 															Code Starts From Here Done By Roshan Tailor Date :- 03/10/2015 MM/DD/YYYY -->
															...
															<td> 
																<input type="text" class="textbox" name="deltae" value="${map['28']}"  autocomplete="off">						
															</td>	
<!-- 															Code Ends Here Done By Roshan Tailor 				 -->
															<td> 
															...
															<td> 
																...
																<select name="customer1" style="width: 100px;padding: 1px;">
																	<option value="">Select</option>
																		...
																		<c:forEach items="${customers}" var="customer">
																		<c:set var="custName" value="${map['32']}"/>
																			<c:choose>
																				<c:when test="${customer eq custName}" >
																					<option value="${customer}" selected="selected">${customer}</option>
																				</c:when>
															...
															<td> 
																...
																<select name="customer2" style="width: 100px;padding: 1px;">
																	<option value="">Select</option>
																		...
																		<c:forEach items="${customers}" var="customer">
																		<c:set var="custName" value="${map['33']}"/>
																			<c:choose>
																				<c:when test="${customer eq custName}" >
																					<option value="${customer}" selected="selected">${customer}</option>
																				</c:when>
...
<spring:url value="/pm5reel/update" var="updateReelUrl"/>
...
$(function(){
	...
	$("#tableBody tr input[type=text],#tableBody tr select[name=customer],#tableBody tr select[name=customer1],#tableBody tr select[name=customer2],#tableBody tr select[name=gradeCode]").focus(function(){
...
// 					Code Ends Here Done By Roshan Tailor
	...
	$("#tableBody tr input[type=text],#tableBody tr select[name=customer],select[name=customer1],select[name=customer2],#tableBody tr select[name=gradeCode]").focusout(function(){
		var val=$(this).val();
...
// 			alert("Second Time::Lvalue"+lvalue+"Avalue::"+avalue+"Bvalue"+bvalue);		
			...
			$.ajax({
				...
				data:{
					...
					trim : trim,
					crepeRatio : crepeRatio,
// 					Code Strats From Here Done By Roshan Tailor Date :-03/10/2015 MM/DD/YYYY
					lvalue : lvalue,
					avalue : avalue,
					bvalue : bvalue,
					deltae : deltae,
