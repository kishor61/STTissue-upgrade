...
<div class="page-box" id="loadPage">
	...
	<div class="container">
		...
		<c:if test="${data.position == 'stockoperator'}">	
			<spring:url value="/pm5stockoperator/save" var="viewURL"/>
		</c:if>		
						 ...
						 <tr>
						  ...
						  <tr>
						   ...
						   <tr>
						    <td class="tg-yw4l" >Agitator Motor</td>
						    <td class="tg-yw4l" style="text-align: center;">
						   		 <input type="text" class="input" value="${data.brokeSystemCol3}" placeholder="" name="brokeSystemCol3" style="margin-left: 1px !important;float: none;    width: 81px;"/>
						  ...
						  <tr>
						    <td class="tg-yw4l" >Agitator Motor</td>
						    <td class="tg-yw4l" style="text-align: center;">
						   		 <input type="text" class="input" value="${data.brokeSystemCol5}" placeholder="" name="brokeSystemCol5" style="margin-left: 1px !important;float: none;    width: 81px;"/>
						  ...
						  <tr>
						    <td class="tg-yw4l" >Agitator Motor</td>
						    <td class="tg-yw4l" style="text-align: center;">
						   		 <input type="text" class="input" value="${data.brokeSystemCol7}" placeholder="" name="brokeSystemCol7" style="margin-left: 1px !important;float: none;    width: 81px;"/>
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 <input type="text" class="input" value="${data.brokeSystemCol11}" placeholder="" name="brokeSystemCol11" style="margin-left: 1px !important;float: none;    width: 81px;"/>
