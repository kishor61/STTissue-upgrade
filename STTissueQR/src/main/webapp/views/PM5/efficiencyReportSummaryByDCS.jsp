...
<spring:url value="/pm5efficiencyreport/byDcs/save"  var="saveURL"/>
<spring:url value="/pm5efficiencyreport/byDcs/edit" var="editDataURL" />
<spring:url value="/pm5efficiencyreport/byDcs/editton" var="editURL" />
    ...
    <div class="wrapper">
		...
		<div class="content-wrapper" style=" padding-top: 0px !important; background-color: #d4d8e559 !important;">
			...
			<div
					          ...
					          "
					><h5 style="text-align:center; font-weight:bold;color:#343e70;">Reel Ton Report From DCS For PM5</h5></div>
				...
				<div class="table-selector" style="background-color:#c2eadf73 !important; border: 1px solid #7e00ff42;">
					...
					<table>
						<tr>
							...
							<td><input type="submit" value="Submit"class="btn btn-success btn-sm"></td>
						</tr>
					</table>
					</form>
				</div>
