					...
					<table style="margin: auto;">
						<tr>
							...
							<td>
								...
								<a href="../operatorCareCheckListPM5/checkObcc/back"><button  type="button" >Backdated Entry
							</button></a>
							</td>
	 					</tr>
					</table>
		   ...
		   <h1 style="font-size: 21px;color: #518f3e;">Night Shift Form</h1>
		 	...
		 	<div style="display: none;" id="div_show">
		 		...
		 		<div style="float: right;}">
		 			<span><b style="font-size: 15px;">lead Operator : </b>${data.operatorName}</span>
		 		</div>
