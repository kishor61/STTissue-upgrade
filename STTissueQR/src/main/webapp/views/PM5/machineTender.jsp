...
$(function(){
	...
	function operatorSelect(value)
	{
		...
		//alert(date);
			...
			{
				location.href="./../pm5R1Operator/view?shift="+value+"&position="+position+"&date="+date+"&operatorname="+operatorname+"&crew="+crew;
			}
	}
...
<div class="page-box" id="loadPage">
	...
	<div class="container">
		...
		<c:if test="${data.position == 'machinetender'}">	
			<spring:url value="/pm5machineTend/save" var="viewURL"/>
		</c:if>		
				 ...
				 <table border="1" class="tg" style="background-color: white;width: 1122px;" id="tbbl">
						...
						<tr>
						  ...
						  <tr>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="formingSectionCol13" ${data.formingSectionCol13 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="formingSectionCol14" ${data.formingSectionCol14 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="checkheadboxaircompressorintelfiltercleanliness" ${data.checkheadboxaircompressorintelfiltercleanliness == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="suctionPressureRollCol7" ${data.suctionPressureRollCol7 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="yankeeDryerCol3" ${data.yankeeDryerCol3 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="yankeeDryerCol5" ${data.yankeeDryerCol5 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						 ...
						 <tr>
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="pressSectionCol6" ${data.pressSectionCol6 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="pressSectionCol8" ${data.pressSectionCol8 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <tr>
						    <td class="tg-yw4l" >North Uhle Box Vacuum ("Hg)</td>
						    <td class="tg-yw4l" style="text-align: center;">
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="upperPressCol3" ${data.upperPressCol3 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="upperPressCol4" ${data.upperPressCol4 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="upperPressCol5" ${data.upperPressCol5 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l" > Felt passivator shower Posistion Correctness & Cleanliness</td>
						    <td class="tg-yw4l" style="text-align: center;">
						   		 <input type="radio" value="true" ${data.upperPressCol6 == 'true' ? 'checked' : ''} name="upperPressCol6"/> Yes 
						   		 <input type="radio" value="false" name="upperPressCol6" ${data.upperPressCol6 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="upperPressCol7" ${data.upperPressCol7 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="upperPressCol8" ${data.upperPressCol8 == 'false' ? 'checked' : ''}/> Off  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 <input type="radio" value="true" ${data.upperPressCol9 == 'true' ? 'checked' : ''} name="upperPressCol9"/> On 
						   		 <input type="radio" value="false" name="upperPressCol9" ${data.upperPressCol9 == 'false' ? 'checked' : ''}/> Off  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						 ...
						 <c:if test="${data.shift == 'night'}"> 	  	
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Fan pump Gearbox</td>
						    	...
						    	<input type="radio" value="false" ${data.fanPumpCol2 == 'false' ? 'checked' : ''} name="fanPumpCol2"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<!-- <tr>
						    <td class="tg-yw4l"  >Lube oil area</td>
						    	...
						    	<input type="radio" value="false" ${data.selectifierScreenCol7 == 'false' ? 'checked' : ''} name="selectifierScreenCol7"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l"  >#1 Lube pump North</td>
						    	...
						    	<input type="radio" value="false" ${data.selectifierScreenCol8 == 'false' ? 'checked' : ''} name="selectifierScreenCol8"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <tr>
						    <td class="tg-yw4l"  >#1 Lube pump South</td>
						    	...
						    	<input type="radio" value="false" ${data.selectifierScreenCol10 == 'false' ? 'checked' : ''} name="selectifierScreenCol10"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <tr>
						    <td class="tg-yw4l"  >Vacuum pump motor 100 Hp</td>
						    	...
						    	<input type="radio" value="false" ${data.vacumePumpCol1 == 'false' ? 'checked' : ''} name="vacumePumpCol1"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Vacuum pump motor 100 Hp</td>
						    	...
						    	<input type="radio" value="false" ${data.vacumePumpCol2 == 'false' ? 'checked' : ''} name="vacumePumpCol2"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.vacumePumpCol3 == 'false' ? 'checked' : ''} name="vacumePumpCol3"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l"  >Vacuum pump motor 1500 Hp</td>
						    	...
						    	<input type="radio" value="false" ${data.vacumePumpCol6 == 'false' ? 'checked' : ''} name="vacumePumpCol6"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Vacuum pump motor 1500 Hp</td>
						    	...
						    	<span style="margin-right: 56px;"> Temperature   </span> Inbound:<input type="text" class="input" value="${data.vacumePumpCol7Inbound}" placeholder="" name="vacumePumpCol7Inbound" style="margin-left: 1px !important;float: none;    width: 81px;"/>
					   		 	 Outbound:<input type="text" class="input" value="${data.vacumePumpCol7Outbound}" placeholder=" " name="vacumePumpCol7Outbound" style="margin-left: 1px !important;float: none;    width: 81px;"/>
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.vacumePumpCol8 == 'false' ? 'checked' : ''} name="vacumePumpCol8"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.vacumePumpCol11 == 'false' ? 'checked' : ''} name="vacumePumpCol11"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Vacuum pump motor 1750 Hp</td>
						    	...
						    	<input type="radio" value="false" ${data.vacumePumpCol14 == 'false' ? 'checked' : ''} name="vacumePumpCol14"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.vacumePumpCol16 == 'false' ? 'checked' : ''} name="vacumePumpCol16"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.vacumePumpCol19 == 'false' ? 'checked' : ''} name="vacumePumpCol19"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.vacumePumpCol22 == 'false' ? 'checked' : ''} name="vacumePumpCol22"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.vacumePumpCol25 == 'false' ? 'checked' : ''} name="vacumePumpCol25"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.vacumePumpCol28 == 'false' ? 'checked' : ''} name="vacumePumpCol28"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.vacumePumpCol31 == 'false' ? 'checked' : ''} name="vacumePumpCol31"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.vacumePumpCol34 == 'false' ? 'checked' : ''} name="vacumePumpCol34"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 ...
						    	 <span style="margin-right: 49px">  Diff pressure </span>  <input type="text" class="input" value="${data.riverWaterCol1}" placeholder=" " name="riverWaterCol1" style="margin-left: 1px !important;float: none;"/>
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 ...
						    	 <span style="margin-right: 49px">  Diff pressure </span>  <input type="text" class="input" value="${data.riverWaterCol2}" placeholder=" " name="riverWaterCol2" style="margin-left: 1px !important;float: none;"/>
						 ...
						 <tr>
						    <td class="tg-yw4l"  >#2 Fresh Water booster pump</td>
						    	...
						    	<input type="radio" value="false" ${data.showercol1 == 'false' ? 'checked' : ''} name="showercol1"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <tr>
						    <td class="tg-yw4l"  >#3 Fresh Water booster pump</td>
						    	...
						    	<input type="radio" value="false" ${data.showercol3 == 'false' ? 'checked' : ''} name="showercol3"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l"  >HP Shower Pump</td>
						    	...
						    	<input type="radio" value="false" ${data.showercol5 == 'false' ? 'checked' : ''} name="showercol5"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	   ...
						    	   <input type="text" class="input" value="${data.showercol7}" placeholder=" " name="showercol7" style="margin-left: 1px !important;float: none;"/>
						...
						<tr>
				    	 ...
				    	 <tr>
						    <td class="tg-yw4l" >Fill up Centerline sheets</td>
						    <td class="tg-yw4l" style="text-align: center;">
						        
						    	   
						    	  Every Shift :<input type="radio" value="true" ${data.fillupcentcol1 == 'true' ? 'checked' : ''} name="fillupcentcol1"/> Yes  
						    	  <input type="radio" value="false" ${data.fillupcentcol1 == 'false' ? 'checked' : ''} name="fillupcentcol1"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.fillupcentcol2 == 'false' ? 'checked' : ''} name="fillupcentcol2"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.fillupcentcol3 == 'false' ? 'checked' : ''} name="fillupcentcol3"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  ...
						    	  <input type="radio" value="false" ${data.fillupcentcol4 == 'false' ? 'checked' : ''} name="fillupcentcol4"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	   ...
						    	   <input type="text" class="input" value="${data.fillupcentcol5}" placeholder=" " name="fillupcentcol5" style="margin-left: 1px !important;float: none;"/>
				     	...
				     	<tr>
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="checkairfilterforheadbox" ${data.checkairfilterforheadbox == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="blowwetendanddryendmotor" ${data.blowwetendanddryendmotor == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	...
						    	<input type="radio" value="false" ${data.headboxairfilterscleaning == 'false' ? 'checked' : ''} name="headboxairfilterscleaning"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <!-- Code Ends Here Done By Roshan Tailor -->
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	    ...
						    	    Every Shift :<input type="radio" value="true" ${data.fillupcentcol8 == 'true' ? 'checked' : ''} name="fillupcentcol8"/> Yes  
						    	  <input type="radio" value="false" ${data.fillupcentcol8 == 'false' ? 'checked' : ''} name="fillupcentcol8"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						    	   
						    	
							     <input type="text" class="input" value="${data.fillupcentcol8Desc}" name="fillupcentcol8Desc" placeholder="Remarks" style="float: right;"/>
						    </td>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	    ...
						    	    Every Shift :<input type="radio" value="true" ${data.fillupcentcol9 == 'true' ? 'checked' : ''} name="fillupcentcol9"/> Yes  
						    	  <input type="radio" value="false" ${data.fillupcentcol9 == 'false' ? 'checked' : ''} name="fillupcentcol9"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						    	   
						    	
							     <input type="text" class="input" value="${data.fillupcentcol9Desc}" name="fillupcentcol9Desc" placeholder="Remarks" style="float: right;"/>
						    </td>
