...
<div class="page-box" id="loadPage">
	...
	<div class="container">
		...
		<c:if test="${data.position == 'backtender'}">	
			<spring:url value="/pm5backtender/save" var="viewURL"/>
		</c:if>		
		 	...
		 	<br/><br/><br/><br/><br/>
				 <table border="1" class="tg" style="background-color: white;width: 1122px;" id="tbbl">
					 ...
					 <c:if test="${data.shift == 'day'}"> 	
						...
						<tr>
						  ...
						  <tr>
						   ...
						   <tr>
						    <td class="tg-yw4l" > Hydraulic Moter temparature </td>
						    <td class="tg-yw4l" style="text-align: center;">
						   		 <input type="radio" value="true" ${data.reelCol4 == 'true' ? 'checked' : ''} name="reelCol4"/> Yes 
						   		 <input type="radio" value="false" name="reelCol4" ${data.reelCol4 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						    ...
						    <tr>
						    <td class="tg-yw4l" >Guage Pressure </td>
						    <td class="tg-yw4l" style="text-align: center;">
						 ...
						 <tr>
						    <td class="tg-yw4l" > Record Tank Electrical Heaters Status  </td>
						    <td class="tg-yw4l" style="text-align: center;">
						   		 <input type="radio" value="true" ${data.machineLubricationCol3 == 'true' ? 'checked' : ''} name="machineLubricationCol3"/> Yes 
						   		 <input type="radio" value="false" name="machineLubricationCol3" ${data.machineLubricationCol3 == 'false' ? 'checked' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						 ...
						 <tr>
						  ...
						  <tr>
						   ...
						   <tr>
						    ...
						    <tr>
						    <td class="tg-yw4l"  >Sending Condensate to IP</td>
						    
						    	<td class="tg-yw4l" style="text-align: center;">
						    	
						    	 
						    	<input type="radio" value="true" ${data.condensateCol15 == 'true' ? 'checked' : ''} name="condensateCol15"/> Yes  
						    	<input type="radio" value="false" ${data.condensateCol15 == 'false' ? 'checked' : ''} name="condensateCol15"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						 ...
						 <tr>
						    <td class="tg-yw4l"  >Flatbox sealpit Pump</td>
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Flatbox sealpit Pump Motor</td>
						    
						    	<td class="tg-yw4l" style="text-align: center;">
						    	
						    	
						    	<span style="margin-right: 56px;"> Temperature   </span> Inbound:<input type="text" class="input" value="${data.showerWaterCol7Inbound}" placeholder="" name="showerWaterCol7Inbound" style="margin-left: 1px !important;float: none;    width: 81px;"/>
						   		  Outbound:<input type="text" class="input" value="${data.showerWaterCol7Outbound}" placeholder=" " name="showerWaterCol7Outbound" style="margin-left: 1px !important;float: none;    width: 81px;"/>
						 ...
						 <c:if test="${data.shift == 'night'}"> 
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Top Felt Guide Paddle Position Correctness & Cleanliness</td>
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Bott. Felt Guide Paddle Position Correctness & Cleanliness</td>
						    
						    	<td class="tg-yw4l" style="text-align: center;">
						    	
						    	 
						    	<input type="radio" value="true" ${data.afterDryerCol5 == 'true' ? 'checked' : ''} name="afterDryerCol5"/> Yes  
						    	<input type="radio" value="false" ${data.afterDryerCol5 == 'false' ? 'checked' : ''} name="afterDryerCol5"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Felt health</td>
						    
						    	<td class="tg-yw4l" style="text-align: center;">
						    	
						    	 
						    	<input type="radio" value="true" ${data.afterDryerCol6 == 'true' ? 'checked' : ''} name="afterDryerCol6"/> Good  
						    	<input type="radio" value="false" ${data.afterDryerCol6 == 'false' ? 'checked' : ''} name="afterDryerCol6"/> Bad &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						 ...
						 <tr>
						    <td class="tg-yw4l"  >Verify Scanner Chiller Water Level is Present</td>
						    
						    	<td class="tg-yw4l" style="text-align: center;">
						    	
						    	 
						    	<input type="radio" value="true" ${data.eqptScannerCol2 == 'true' ? 'checked' : ''} name="eqptScannerCol2"/> Yes  
						    	<input type="radio" value="false" ${data.eqptScannerCol2 == 'false' ? 'checked' : ''} name="eqptScannerCol2"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						 ...
						 <tr>
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Spool starter fix condition</td>
					...
					<tr>
						 ...
						 <tr>
						    <td class="tg-yw4l"  >Wash and clean M/c floors from the of after dryers to <br /> refiners  (T/S and D/S)</td>
						 ...
						 <tr>
						    <td class="tg-yw4l"  >Check Blade Change</td>
						    	<td class="tg-yw4l" style="text-align: center;">
						    	<input type="radio" value="true" ${data.checkbladechange == 'true' ? 'checked' : ''} name="checkbladechange"/> Yes  
						    	<input type="radio" value="false" ${data.checkbladechange == 'false' ? 'checked' : ''} name="checkbladechange"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Gloves For Holes</td>
						    	<td class="tg-yw4l" style="text-align: center;">
						    	<input type="radio" value="true" ${data.celovesforholes == 'true' ? 'checked' : ''} name="celovesforholes"/> Yes  
						    	<input type="radio" value="false" ${data.celovesforholes == 'false' ? 'checked' : ''} name="celovesforholes"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
