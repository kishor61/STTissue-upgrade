...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="content-wrapper" style=" padding-top: 0px !important; background-color: #d4d8e559 !important;">
		<div
		          ...
		          "
		><h5 style="text-align:center; font-weight:bold;color:#343e70;">PULP AND UTILITY CONSUMPTION REPORT PM5</h5></div>
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
					...
					<table style="margin: auto;">
						<tr>
							...
							<td>&nbsp; <c:if test="${page eq 'U'}">
									...
									&nbsp;&nbsp;
									<button id="deleteRowBtn"  class="btn btn-danger btn-sm">Delete</button>
								</c:if> <c:if test="${page eq 'M'}">
									<button id="addRowBtn">Add Row</button>
									<button onclick="location.href='<spring:url value="/pm5utilitykpimaster/masterbackdatedentry"/>'">Back Dated Entry</button>
							</td> 
							<td>
				...
				<div>
					...
					<!-- Master Page -->
					<c:if test="${page eq 'M'}">
						<jsp:include page="../PM5/utilityKpiMasterNewMaster.jsp" />
					</c:if>
