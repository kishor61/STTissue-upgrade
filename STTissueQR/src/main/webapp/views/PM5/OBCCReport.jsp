...
<spring:url value="/pm5OBCCReport/view/report/data/detailedreport/email" var="emailURL"/>
<spring:url value="/pm5OBCCReport/view/report/data/detailedreport/count" var="countURl"/>
<script type="text/javascript">
	$(function(){
...
<body>
	...
	<div class="container">
		...
		<div class="block3" style="overflow: auto;">
			...
			<spring:url value="/pm5OBCCReport/view/report/data/detailedreport/export" var="viewURL"/>
