...
<div class="page-box" id="loadPage">
	...
	<div class="container">
		...
		<c:if test="${data.position == 'R1'}">	
			<spring:url value="/R1Operator/save" var="viewURL"/>
		</c:if>		
				 ...
				 <table border="1" class="tg" style="background-color: white;width: 1122px;" id="tbbl">
						...
						<tr>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	<span style="margin-left: -88px;">Over Heating</span>
						   		 <input type="text"  name="leadInRollCol1" value="${data.leadInRollCol1}"  placeholder="Temp"/>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	<span style="margin-left: -87px;">Oil Leakage</span>
						   		 ...
						   		 <input type="radio" value="false" name="leadInRollCol2" ${data.leadInRollCol2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -115px;">Abnormal Sound</span>
						   		 ...
						   		 <input type="radio" value="false" name="leadInRollCol3" ${data.leadInRollCol3 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	  <span style="margin-left: -88px;">Over Heating</span>
						   		 <input type="text"  name="leadInRollCol4" value="${data.leadInRollCol4}"  placeholder="Temp"/>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						     	  <span style="margin-left: -115px;">Abnormal Sound</span>
						   		 ...
						   		 <input type="radio" value="false" name="leadInRollCol5" ${data.leadInRollCol5 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						          <span style="margin-left: -88px;">Free Turning</span>
						   		 ...
						   		 <input type="radio" value="false" name="sectionRollCol1" ${data.sectionRollCol1 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -61px;">Leakage</span>
						   		 ...
						   		 <input type="radio" value="false" name="breakAssemblyCol1" ${data.breakAssemblyCol1 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<%--   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="breakAssemblyCol2" ${data.breakAssemblyCol2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="slittersCol1" ${data.slittersCol1 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="trimAssemblyCol1" ${data.trimAssemblyCol1 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <%-- 
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -88px;">Over Heating</span>
						   		 ...
						   		 <input type="radio" value="false" name="trimAssemblyCol2" ${data.trimAssemblyCol2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -115px;">Abnormal Sound</span>
						   		 ...
						   		 <input type="radio" value="false" name="trimAssemblyCol3" ${data.trimAssemblyCol3 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="trimAssemblyCol4" ${data.trimAssemblyCol4 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	<span style="margin-left: -96px;">Free Truning</span>
						   		 ...
						   		 <input type="radio" value="false" name="tensiionRollCol1" ${data.tensiionRollCol1 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -96px;">No Build-Up</span>
						   		 ...
						   		 <input type="radio" value="false" name="tensiionRollCol2" ${data.tensiionRollCol2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="tensiionRollCol3" ${data.tensiionRollCol3 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    	<td class="tg-yw4l" colspan="2" style="background-color: rgba(128, 128, 128, 0.52);"><h2>WINDER DRUM NORTH</h2></td>
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						     	 <span style="margin-left: -88px;">Over Heating</span>
						   		 <input type="text" name="winderDrum1Col1" value="${data.winderDrum1Col1}" placeholder="" />  
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						     	 <span style="margin-left: -96px;">Oil Leakage</span>
						   		 ...
						   		 <input type="radio" value="false" name="winderDrum1Col2" ${data.winderDrum1Col2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -115px;">Abnormal Sound</span>
						   		 ...
						   		 <input type="radio" value="false" name="winderDrum1Col3" ${data.winderDrum1Col3 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	<span style="margin-left: -88px;">Over Heating</span>
						   		 <input type="text" value="${data.winderDrum1Col4}" name="winderDrum1Col4"/>
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -115px;">Abnormal Sound</span>
						   		 ...
						   		 <input type="radio" value="false" name="winderDrum1Col5" ${data.winderDrum1Col5 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <%-- <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -88px;">Over Heating</span>
						   		 ...
						   		 <input type="radio" value="false" name="winderDrum1Col6" ${data.winderDrum1Col6 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -115px;">Abnormal Sound</span>
						   		 ...
						   		 <input type="radio" value="false" name="winderDrum1Col7" ${data.winderDrum1Col7 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    	<td class="tg-yw4l" colspan="2" style="background-color: rgba(128, 128, 128, 0.52);"><h2>WINDER DRUM SOUTH</h2></td>
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -88px;">Over Heating</span>
						   		 <input type="text" value="${data.winderDrum2Col1}"  name="winderDrum2Col1"/>
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						     	 <span style="margin-left: -96px;">Oil Leakage</span>
						   		 ...
						   		 <input type="radio" value="false" name="winderDrum2Col2" ${data.winderDrum2Col2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						     	 <span style="margin-left: -115px;">Abnormal Sound</span>
						   		 ...
						   		 <input type="radio" value="false" name="winderDrum2Col3" ${data.winderDrum2Col3 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -88px;">Over Heating</span>
						   		 <input type="text" value="${data.winderDrum2Col4}"  name="winderDrum2Col4"/> 
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -115px;">Abnormal Sound</span>
						   		 ...
						   		 <input type="radio" value="false" name="winderDrum2Col5" ${data.winderDrum2Col5 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<%--   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						     	 <span style="margin-left: -88px;">Over Heating</span>
						   		 ...
						   		 <input type="radio" value="false" name="winderDrum2Col6" ${data.winderDrum2Col6 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						         <span style="margin-left: -96px;"> Abnormal Sound</span>
						   		 ...
						   		 <input type="radio" value="false" name="winderDrum2Col7" ${data.winderDrum2Col7 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <br/>
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="rollEjectorCol1" ${data.rollEjectorCol1 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="rollEjectorCol2" ${data.rollEjectorCol2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="rollEjectorCol3" ${data.rollEjectorCol3 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						     	 <span style="margin-left: -88px;">Over Heating</span>
						   		 ...
						   		 <input type="radio" value="false" name="riderRollCol1" ${data.riderRollCol1 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -96px;">Oil Leakage</span>
						   		 ...
						   		 <input type="radio" value="false" name="riderRollCol2" ${data.riderRollCol2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -96px;">Abnormal Sound</span>
						   		 ...
						   		 <input type="radio" value="false" name="riderRollCol3" ${data.riderRollCol3 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -88px;">Over Heating</span>
						   		 <input type="text" value="${data.riderRollCol4}"  name="riderRollCol4"/>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -96px;">Abnormal Sound</span>
						   		 ...
						   		 <input type="radio" value="false" name="riderRollCol5" ${data.riderRollCol5 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="riderRollCol6" ${data.riderRollCol6 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <%--  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="riderRollCol7" ${data.riderRollCol7 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="riderRollCol8" ${data.riderRollCol8 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						     	 <span style="margin-left: -88px;">Over Heating</span>
						   		 <input type="text" value="${data.bowedRollCol1}"  name="bowedRollCol1"/>
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						     	 <span style="margin-left: -96px;">Abnormal Sound</span>
						   		 ...
						   		 <input type="radio" value="false" name="bowedRollCol2" ${data.bowedRollCol2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="bowedRollCol3" ${data.bowedRollCol3 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="coreChucksCol1" ${data.coreChucksCol1 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="coreChucksCol2" ${data.coreChucksCol2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	<span style="margin-left: -60px;">Leakage</span>
						   		 ...
						   		 <input type="radio" value="false" name="coreChucksCol3" ${data.coreChucksCol3 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="coreChucksCol4" ${data.coreChucksCol4 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="nipGuardCol1" ${data.nipGuardCol1 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="nipGuardCol2" ${data.nipGuardCol2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	 <span style="margin-left: -60px;">Leakage</span>
						   		 ...
						   		 <input type="radio" value="false" name="nipGuardCol3" ${data.nipGuardCol3 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   ...
						   <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="tableLeftGateCol1" ${data.tableLeftGateCol1 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="tableLeftGateCol2" ${data.tableLeftGateCol2 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
