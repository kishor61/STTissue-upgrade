...
<spring:url value="/utilitykpimaster/deletemaster"  var="deleteUrl"/>
...
<spring:url value="/utilitykpimasterreport/exportmaster" var="exportDataURL"/>
...
<table id="masterTable" class="table"
	...
	<thead>
		...
		<tr>
			...
			<th colspan="6">PM #6 Energy Data</th>
			
			<th rowspan="3"></th>
			
			<th colspan="4">PM #6 Condensate Efficiency</th>
			
			<th rowspan="3"></th>
			
			<!-- <th colspan="6">PM #6 &#38; FRP Pulp Utilization</th> -->
			<th colspan="6"></th>	
