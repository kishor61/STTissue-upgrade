...
<spring:url value="/clrewinder/report/load" var="showReportURL" />
<spring:url value="/clrewinder/report/delete" var="deletewinderDataURL" />
<spring:url value="/clrewinder/report/export" var="exportReportURL"/>
<spring:url value="/clrewinder/editWinderReport" var="editURL" />
