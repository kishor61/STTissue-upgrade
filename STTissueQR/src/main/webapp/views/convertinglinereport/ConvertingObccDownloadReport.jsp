...
<spring:url value="/frpobccReport/view/report/data/detailedreport/exportPercentage/email" var="emailURL"/>
<script type="text/javascript">
	$(function(){
...
<body>
	...
	<div class="container">
		...
		<spring:url value="/convertinglineOBCC/view/report/data/detailedreport/exportPercentage" var="viewURL"/>
		<form name="dataForm" action="${viewURL}" method="post">
			<div class="pageContent">

				<div class="page-title">
					<span class="label">convertinglineOBCC Download Report</span>
				</div>
