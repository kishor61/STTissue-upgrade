		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<div class="page-title">
					<span class="label">Converting Line Report SKU Code Wise</span>
				</div>
				<div class="table-selector">
					<spring:url value="/convertinglinereport/skucodewise/view/data" var="viewURL"/>
...
<form id="exportFrom" action='<spring:url value="/convertinglinereport/skucodewise/ExcelExport"/>'method="GET" style="display: none;" target="_blank">
	<input type="hidden" name="sdate" value="${sdate}">
	<input type="hidden" name="edate" value="${edate}"> 
	<input type="hidden" name="skucode" value="${searchedskucode}">
</form>					
