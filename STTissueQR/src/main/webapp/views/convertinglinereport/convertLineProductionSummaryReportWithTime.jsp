...
<spring:url value="/convertinglinereport/reportconvertinglineproductionwithtime/export/email" var="emailURL"/>
<script type="text/javascript">
	$(function(){
	...
	<div class="container">
		...
		<div class="block3" style="overflow: auto;">
			<div class="pageContent">
				...
				<spring:url value="/convertinglinereport/viewsummary/data/withtime" var="viewURL"/>
				...
				<form id="exportFrom" action='<spring:url value="/convertinglinereport/reportconvertinglineproductionwithtime/export"/>'  method="GET" style="display:none; " target="_blank">
...
<table id="reportTable1" class="table" style="width: 600px; margin: auto; font-size: 12px;">
	<thead>
		...
		<tr class="trobjrow">
			...
			<th colspan="3">Shift : Day</th>
		</tr>
		<tr>
			<!-- <th>Date</th>
			<th>Shift</th> -->
			<th colspan="3">Reel Number</th>
			<th colspan="3">Grade Code</th>
			<!-- <th>Total Weight</th>
			<th>Diameter</th>
			<th>Roll Width</th>
			<th>Parent Core</th> -->
	...
	<tbody>
		<c:forEach items="${parentData}" var="pd">
			<tr>
				...
				<td colspan="3" style="width: 100px;">${pd.parentrollid}</td>
				<td colspan="3" style="width: 100px;">${pd.parentgradecode}</td>
		...
		<tr>
			...
			<th colspan="1">Start<br />Time</th>
			<th colspan="1">End<br />Time</th>
		...
		<c:forEach items="${caseData}" var="cd">
			...
			<tr style="background-color: rgba(24, 23, 39, 0.28);">
				<td colspan="4" style="width: 50px;"><b>Total</b></td>
				<td style="width: 100px;"><b>${firstcase}</b></td>
				<td style="width: 100px;"><b>${secodcase}</b></td>
			</tr>
			<tr style="background-color: rgba(24, 23, 39, 0.28);">
				<td colspan="4" style="width: 50px;"><b>Ratio</b></td>
				<%-- <td style="width: 100px;"><b>${(firstcase/(firstcase+secodcase))*100}%</b></td>
				<td style="width: 100px;"><b>${(secodcase/(firstcase+secodcase))*100}%</b></td> --%>
