...
<spring:url value="/efficiency/timedurtation" var="timedurtationURL" />
<spring:url value="/efficiency/savenew" var="saveURL" />
<spring:url value="/efficiency/delete" var="deleteURL" />
<spring:url value="/efficiency/totalduration" var="totalTimeURL" />

<spring:url value="/efficiency/current/info" var="currentInfoURL" />
...
<spring:url value="/efficiency/new" var="oldDataURL" />
<script type="text/javascript">
	$(function(){
