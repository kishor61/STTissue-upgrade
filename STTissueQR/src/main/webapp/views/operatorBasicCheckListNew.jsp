    ...
    <div class="wrapper">
		...
		<div class="content-wrapper" style=" padding-top: 0px !important; background-color: #d4d8e559 !important;">
				<div
				          ...
				          "
				><h5 style="text-align:center; font-weight:bold;color:#343e70;">Operator Basic Care CheckList PM6</h5></div>
					...
					<table >
						<tr>
							...
							<td>
								...
								<a href="../operatorCareCheckList/checkObcc/back"><button  type="button" class="btn btn-info btn-sm">Backdated Entry
							</button></a>
							</td>
	 					</tr>
					</table>
		 	...
		 	<div style="display:none;" id="div_show">
						...
						<tr>
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						    	...
						    	<input type="radio"  name="movementcol1" value="true" ${data.movementcol1 == 'true' ? 'checked' : ''}/> Yes <input type="radio"  name="movementcol1" value="false" ${data.movementcol1 == 'false' ? '' : ''}/> No
						 ...
						 <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						   		 ...
						   		 <input type="radio" value="false" name="conveyorcol1" ${data.conveyorcol1 == 'false' ? '' : ''}/> No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    ...
						    <input type="radio" value="true" ${data.conveyorcol2 == 'true' ? 'checked' : ''} name="conveyorcol2"/> Yes 
						     <input type="radio" value="false" ${data.conveyorcol2 == 'false' ? '' : ''} name="conveyorcol2"/>No   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
						  ...
						  <tr>
						    ...
						    <td class="tg-yw4l" style="text-align: center;">
						     ...
						     <input type="radio" value="false"  ${data.conveyorcol3 == 'false' ? '' : ''} name="conveyorcol3"/>No    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
						    ...
						    <input type="radio" value="false"  ${data.conveyorcol4 == 'false' ? '' : ''} name="conveyorcol4"/>No  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
						   ...
						   <tr>
						    ...
						    <input type="radio" value="false"  ${data.conveyorcol5 == 'false' ? '' : ''} name="conveyorcol5"/>No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Power</td>
						    	...
						    	<input type="radio" value="false" ${data.powercol1 == 'false' ? '' : ''} name="powercol1"/> OFF &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Blade</td>
						    	...
						    	<input type="radio" value="false" ${data.powercol2 == 'false' ? '' : ''} name="powercol2"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l">Vacuum</td>
						    	...
						    	<input type="radio" value="false" ${data.powercol3 == 'false' ? '' : ''} name="powercol3"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						    <td class="tg-yw4l"  >Size Adjustment Movement</td>
						    	...
						    	<input type="radio" value="false" ${data.powercol4 == 'false' ? '' : ''} name="powercol4"/> No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tr>
						   ...
						   <input type="radio" value="false" ${data.ordercol1 == 'false' ? '' : ''} name="ordercol1"/>No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			   ...
			   <c:choose>
			    <c:when test="${edit == 'yes'}">
			       <div class="wrapper">
						<br /><br />
						<button type="button" id="printBtn1" class="button" class="btn btn-success btn-sm">Print</button>
						<button class="button" type="submit" class="btn btn-info btn-sm">Edit</button>
					</div>
			    </c:when>
			    ...
			    <c:otherwise>
			        <div class="wrapper">
						<br /><br />
						<button type="button" id="printBtn1" class="button" class="btn btn-success btn-sm">Print</button>
						<button class="button" type="submit" class="btn btn-info btn-sm">Submit</button>
					</div>
			    </c:otherwise>
			</c:choose>
