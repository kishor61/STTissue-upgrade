...
(
	select DateEntered,RollNumber,
	 ...
	 from tblWrapperProduction where RollNumber in (select SetNumber from tblRewinderProduction as t where ReelNumber1=:reelNo  and year(t.DateEntered)=:yr)  and DateEntered=:dateEntered
